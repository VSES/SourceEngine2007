...
public:
	CDODClassMenu_Allies::CDODClassMenu_Allies(IViewPort *pViewPort) : BaseClass(pViewPort)
	{
...
public:
	CDODClassMenu_Axis::CDODClassMenu_Axis(IViewPort *pViewPort) : BaseClass(pViewPort)
	{
