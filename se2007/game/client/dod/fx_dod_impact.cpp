...
//-----------------------------------------------------------------------------
void DOD_PerformCustomEffects( const Vector &vecOrigin, trace_t &tr, const Vector &shotDir, int iMaterial, int iScale )
{
...
void ImpactCallback( const CEffectData &data )
{
	...
	{
		int iScale = 1;	// argh, scale is int..
