...
public:
	...
	virtual unsigned int PlayerSolidMask( bool brushOnly );
...
bool CDODGameMovement::CanUnduck()
{
	trace_t trace;
	Vector newOrigin;
...
// Output : const Vector
//-----------------------------------------------------------------------------
const Vector& CDODGameMovement::GetPlayerMins( void ) const
{
	if ( !player )
	{
		return vec3_origin;
...
// Output : const Vector
//-----------------------------------------------------------------------------
const Vector& CDODGameMovement::GetPlayerMaxs( void ) const
{	
	if ( !player )
	{
		return vec3_origin;
