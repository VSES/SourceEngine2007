...
// MessageText:
//
//  Windows Media Player could not use digital playback to play the CD. To switch to analog playback, on the Tools menu, click Options, and then click the Devices tab. Double-click the CD drive, and then in the Playback area, click Analog.%0
//
...
// MessageText:
//
//  Windows Media Player could not use digital playback to play the CD. The Player has automatically switched the CD drive to analog playback. To switch back to digital CD playback, use the Devices tab.%0
//
...
// MessageText:
//
//  Windows Media Player cannot play the CD. The disc might be dirty or damaged. Turn on error correction, and then try again.%0
//
...
// MessageText:
//
//  Windows Media Player cannot play the CD. The disc might be dirty or damaged or the CD drive might be malfunctioning.%0
//
...
// MessageText:
//
//  Windows Media Player cannot burn the file to the CD. Either the license prohibits burning or you must download a new license to burn the file.%0
//
...
// MessageText:
//
//  Windows Media Player no longer detects a connected portable device. Reconnect your portable device, and then try syncrhonizing the file again.%0
//
...
// MessageText:
//
//  The file cannot be added to the library because it is smaller than the "Skip files smaller than" setting. To add the file, change the setting on the Library tab.%0
//
...
// MessageText:
//
//  Windows Media Player cannot download the license for a file that is queued in the playlist.%0
//
...
// MessageText:
//
//  Windows Media Player cannot play the protected file because the license is corrupted. If you previously backed up your licenses, try restoring them.%0
//
...
// MessageText:
//
//  Windows Media Player cannot play the playlist because it does not contain any items.%0
//
...
// MessageText:
//
//  The playlist file cannot be downloaded.%0
//
...
// MessageText:
//
//  Windows Media Player cannot play the file. If the file is located on the Internet, connect to the Internet. If the file is located a removable storage card, insert the storage card.%0
//
...
// MessageText:
//
//  Windows Media Player cannot play any items in the playlist. For additional information, right-click an item that cannot be played, and then click Error Details.%0
//
...
// MessageText:
//
//  Windows Media Player cannot find the file. The link from an item in the library to its associated digital media file might be broken. For additional information, right-click an item that cannot be played, and then click Error Details.%0
//
...
// MessageText:
//
//  Windows Media Player cannot synchronize the file because the device needs to be updated.%0
//
...
// MessageText:
//
//  Windows Media Player cannot play the file because the Macromedia Flash Player is not installed on your computer. To download the Macromedia Flash Player, go to the Macromedia Web site.%0
//
...
// MessageText:
//
//  To play the selected item, you must install a later version of the Macromedia Flash Player. To download the Macromedia Flash Player, go to the Macromedia Web site.%0
//
...
// MessageText:
//
//  Your licenses were not backed up because the backup was canceled.%0
//
...
// MessageText:
//
//  The licenses were not restored because the restoration was canceled.%0
//
...
// MessageText:
//
//  An error occurred during license backup or restore. A required Web page cannot be displayed.%0
//
...
// MessageText:
//
//  The licenses were not backed up because the backup was canceled.%0
//
...
// MessageText:
//
//  Windows Media Player cannot restore licenses from the specified location. Choose another location, and then try again.%0
//
...
// MessageText:
//
//  Windows Media Player cannot play the DVD because a problem occurred with digital copyright protection.%0
//
...
// MessageText:
//
//  Windows Media Player cannot play the DVD because a problem occurred while configuring copyright protection.%0
//
...
// MessageText:
//
//  Windows Media Player cannot play DVD video. Open Display in Control Panel, and then lower your screen resolution and color quality settings. To view the DVD Troubleshooter, click More Information.%0
//
...
// MessageText:
//
//  Windows Media Player cannot skip to the requested location.%0
//
...
// MessageText:
//
//  Windows Media Player cannot play DVD video. Open Display in Control Panel, and then lower your screen resolution and color quality settings.%0
//
...
// MessageText:
//
//  Windows Media Player cannot burn the files to the CD because the Player cannot find a CD burner (recorder). If the burner is connected properly, use the Add Hardware Wizard in Control Panel to install the appropriate driver.%0
//
...
// MessageText:
//
//  Windows Media Player cannot synchronize the file. The Player might not support the file type.%0
//
...
// MessageText:
//
//  Windows Media Player encountered an error while communicating with the portable device. The storage card on the device might be full, the device might not be turned on, or the device does not allow playlists or folders to be created on it.%0
//
...
// MessageText:
//
//  Windows Media Player cannot play the WAV file.%0
//
...
// MessageText:
//
//  Windows Media Player did not burn all of the selected items to the CD. The Player has reduced the recording speed of your CD burner (recorder) to solve the problem. To burn all of the selected items, insert a blank disc into the burner, and then try again.%0
//
...
// MessageText:
//
//  Windows Media Player cannot burn the files to the CD. Verify that your CD burner (recorder) is connected properly, and then try again. If the problem persists, reinstall the Player.%0
//
...
// MessageText:
//
//  Windows Media Player did not synchronize some files to the device because there is not enough storage space on the device.%0
//
...
// MessageText:
//
//  The disc in the CD burner (recorder) is not valid. Insert a blank disc into the burner, and then try again.%0
//
...
// MessageText:
//
//  Windows Media Player cannot perform the requested action because the device does not support synchronization.%0
//
...
// MessageText:
//
//  To perform the requested action, you must first create an automatic or manual partnership with the device.%0
//
...
// MessageText:
//
//  You have already created a partnership with 16 devices. To create a new parternership, you must first delete an existing partnership.%0
//
...
// MessageText:
//
//  Windows Media Player cannot synchronize the protected file. Protected files cannot be converted to the required quality level or file format.%0
//
...
// MessageText:
//
//  There is not enough space to convert the file. Use Tools > Options > Devices > Advanced to delete temporary files or increase available space.%0
//
...
// MessageText:
//
//  There are already 99 files of the same name in the folder on the device. Update the file's media information or synchronize to a different folder.%0
//
...
// MessageText:
//
//  Windows Media Player cannot convert this file format. If available, install an updated version of the codec used to compress this file.%0
//
...
// MessageText:
//
//  The device does not support synchronization. Contact the device manufacturer to find out if an updated driver is available.%0
//
...
// MessageText:
//
//  Windows Media Player cannot synchronize the file because a file with the same name already exists on the device. Try synchronizing the file to a different folder.%0
//
...
// MessageText:
//
//  Automatic and manual synchronization has been temporarily turned off. To synchronize content to a device, restart Windows Media Player.%0
//
...
// MessageText:
//
//  This device is no longer available. Please reconnect the device to continue.%0
//
...
// MessageText:
//
//  Windows Media Player cannot synchronize the file. An error occurred while converting the file to another quality level or format. If the problem persists, remove the file from the list.%0
//
...
// MessageText:
//
//  Windows Media Player cannot play the file because there is not enough storage space on your computer. Delete some unneeded files on your hard disk, and then try again.%0
//
...
// MessageText:
//
//  Windows Media Player cannot play the file. If the file is on another computer, verify that you are connected to the network. If you typed a path, verify that it is correct. If the problem persists, the server might not be available.%0
//
...
// MessageText:
//
//  Windows Media Player encountered an error while burning the CD. Verify that the CD burner (recorder) is connected properly and that the disc is clean and not damaged.%0
//
...
// MessageText:
//
//  To play the file, you must install the latest Windows XP service pack.  To install the service pack from the Windows Update Web site, click Web Help.%0
//
...
// MessageText:
//
//  Windows Media Player cannot synchronize the file because the portable device does not support protected files.%0
//
...
// MessageText:
//
//  Windows Media Player cannot synchronize the file because the license is missing. If you obtained the file from a Web site, try downloading the file again.%0
//
...
// MessageText:
//
//  Windows Media Player cannot synchronize the file because the license has expired. If you obtained the file from a Web site, try downloading the file again.%0
//
...
// MessageText:
//
//  Windows Media Player cannot synchronize the file because the license or device prohibits it.%0
//
...
// MessageText:
//
//  Windows Media Player cannot synchronize the file because the license prohibits it.%0
//
...
// MessageText:
//
//  Windows Media Player cannot burn the files to the CD. Verify that the CD burner (recorder) is connected properly, and then try again.%0
//
...
// MessageText:
//
//  Windows Media Player cannot burn the files to the CD. Verify that the CD burner (recorder) is connected properly and that the disc is clean and not damaged. If the burner is already in use, wait until the current task finishes or quit other programs that might be using the burner.%0
//
...
// MessageText:
//
//  Windows Media Player cannot play the file because the server is not available (for example, the server is busy or not online).%0
//
...
// MessageText:
//
//  Windows Media Player cannot play the file.%0
//
...
// MessageText:
//
//  To play the file, Windows Media Player must download a license from the Internet. Connect to the Internet, and then try again.%0
//
...
// MessageText:
//
//  To play the file, Windows Media Player must download a license from the Internet. However, the license server is not available (for example, the server is busy or not online).%0
//
...
// MessageText:
//
//  To play the file, you might need to install a later version of Windows Media Player. On the Help menu, click Check For Player Updates, and then follow the instructions.%0
//
...
// MessageText:
//
//  To use the Full Screen command, you might need to adjust your Windows display settings. Open Display in Control Panel, and then try setting Hardware acceleration to Full.%0
//
...
// MessageText:
//
//  Windows Media Player cannot play the file because a network error occurred. The server might not be available (for example, the server is busy or not online) or you might not be connected the network.%0
//
...
// MessageText:
//
//  Windows Media Player cannot play, burn, or synchronize the file because a required audio codec is not installed on your computer.%0
//
...
// MessageText:
//
//  Windows Media Player cannot burn the files to the CD. If the CD burner (recorder) is busy, wait for the current task to finish. If necessary, verify that the burner is connected properly and that you have installed the latest device driver.%0
//
...
// MessageText:
//
//  Windows Media Player encountered an unknown error. This can occur when another program or operating system component encounters a problem but does not communicate the nature of the problem to the Player.%0
//
...
// MessageText:
//
//  Windows Media Player cannot play the protected file because the required security upgrade is not available for download.%0
//
...
// MessageText:
//
//  Windows Media Player cannot play the file because the license is corrupted or not valid. The license might not be valid, for example, if you have replaced hardware components in your computer.%0
//
...
// MessageText:
//
//  Windows Media Player cannot play, synchronize, or burn a protected file because an error occurred while verifying the license.%0
//
...
// MessageText:
//
//  Windows Media Player cannot synchronize or burn the protected file because the Player cannot verify that the license is valid. A problem occured while contacting the Internet to determine the current date and time.%0
//
...
// MessageText:
//
//  Windows Media Player cannot get the list of activated users for this computer. License acquisition will be stopped.%0
//
...
// MessageText:
//
//  Windows Media Player is trying to acquire a license for a file that is no longer being used. License acquisition will stop.%0
//
...
// MessageText:
//
//  Windows Media Player cannot play the protected file. This might occur if the license is missing. For more information, contact the online store from which you downloaded the file.%0
//
