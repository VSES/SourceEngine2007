...
namespace vgui
{
	...
	class CModWizardSubPanel_CopyFiles_Ep1 : public CModWizardSubPanel_CopyFiles
	{

	public:
		CModWizardSubPanel_CopyFiles_Ep1( Panel *parent, const char *panelName );
	...
	class CModWizardSubPanel_CopyFiles_OrangeBox : public CModWizardSubPanel_CopyFiles
	{
	public:
		CModWizardSubPanel_CopyFiles_OrangeBox( Panel *parent, const char *panelName );
