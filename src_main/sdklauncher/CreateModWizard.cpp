...
void SetModWizardStatusCode( unsigned long inputCode )
{
	...
	HKEY hKey;
	if ( RegCreateKeyEx( HKEY_LOCAL_MACHINE, "Software\\Valve\\SourceSDK", 0, 0, 0, KEY_ALL_ACCESS, NULL, &hKey, NULL ) == ERROR_SUCCESS )
	{
	...
	: BaseClass( parent, name )
{
	...
	{
		subPanel = new CModWizardSubPanel_CopyFiles_OrangeBox( this, "CModWizardSubPanel_CopyFiles" );
	}
	else
	{
		subPanel = new CModWizardSubPanel_CopyFiles_Ep1( this, "CModWizardSubPanel_CopyFiles" );		
	}
