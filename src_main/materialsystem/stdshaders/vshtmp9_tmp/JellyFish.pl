...
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(JellyFish.vsh)(8)\n";
push @output, "; Vertex blending																								; LINEINFO(JellyFish.vsh)(9)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(JellyFish.vsh)(10)\n";
...
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(JellyFish.vsh)(20)\n";
push @output, "; Transform the position from world to view space																								; LINEINFO(JellyFish.vsh)(21)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(JellyFish.vsh)(22)\n";
&AllocateRegister( \$projPos, "\$projPos" );																								
push @output, "dp4 $projPos.x, $worldPos, $cViewProj0																								; LINEINFO(JellyFish.vsh)(26)\n";
push @output, "dp4 $projPos.y, $worldPos, $cViewProj1																								; LINEINFO(JellyFish.vsh)(27)\n";
push @output, "dp4 $projPos.z, $worldPos, $cViewProj2																								; LINEINFO(JellyFish.vsh)(28)\n";
push @output, "dp4 $projPos.w, $worldPos, $cViewProj3																								; LINEINFO(JellyFish.vsh)(29)\n";
push @output, "mov oPos, $projPos																								; LINEINFO(JellyFish.vsh)(30)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(JellyFish.vsh)(32)\n";
push @output, "; Fog																								; LINEINFO(JellyFish.vsh)(33)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(JellyFish.vsh)(34)\n";
&CalcFog( $worldPos, $projPos );																								
&FreeRegister( \$projPos, "\$projPos" );																								
&AllocateRegister( \$viewNormal, "\$viewNormal" );																								
push @output, "; Transform the normal from object to view space																								; LINEINFO(JellyFish.vsh)(42)\n";
push @output, "dp3 $viewNormal.x, $worldNormal, $cView0																								; LINEINFO(JellyFish.vsh)(43)\n";
push @output, "dp3 $viewNormal.y, $worldNormal, $cView1																								; LINEINFO(JellyFish.vsh)(44)\n";
push @output, "dp3 $viewNormal.z, $worldNormal, $cView2																								; LINEINFO(JellyFish.vsh)(45)\n";
&FreeRegister( \$worldNormal, "\$worldNormal" );																								
push @output, "; normalize normal (do we need to do this?)																								; LINEINFO(JellyFish.vsh)(48)\n";
&Normalize( $viewNormal );																								
&AllocateRegister( \$viewPos, "\$viewPos" );																								
push @output, "; Transform position from object to view space																								; LINEINFO(JellyFish.vsh)(54)\n";
push @output, "dp4 $viewPos.x, $worldPos, $cView0																								; LINEINFO(JellyFish.vsh)(55)\n";
push @output, "dp4 $viewPos.y, $worldPos, $cView1																								; LINEINFO(JellyFish.vsh)(56)\n";
push @output, "dp4 $viewPos.z, $worldPos, $cView2																								; LINEINFO(JellyFish.vsh)(57)\n";
&FreeRegister( \$worldPos, "\$worldPos" );																								
&AllocateRegister( \$vertToEye, "\$vertToEye" );																								
push @output, "; vector from point to eye in view space																								; LINEINFO(JellyFish.vsh)(62)\n";
push @output, "mov $vertToEye.xyz, -$viewPos																								; LINEINFO(JellyFish.vsh)(63)\n";
&FreeRegister( \$viewPos, "\$viewPos" );																								
push @output, "; normalize																								; LINEINFO(JellyFish.vsh)(67)\n";
&Normalize( $vertToEye );																								
push @output, "dp3 $viewNormal.x, $vertToEye, $viewNormal																								; LINEINFO(JellyFish.vsh)(70)\n";
push @output, "add $viewNormal.x, $viewNormal.x, $SHADER_SPECIFIC_CONST_5 ; FIXME																								; LINEINFO(JellyFish.vsh)(71)\n";
&FreeRegister( \$vertToEye, "\$vertToEye" );																								
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(JellyFish.vsh)(75)\n";
push @output, "; Texture coordinates																								; LINEINFO(JellyFish.vsh)(76)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(JellyFish.vsh)(77)\n";
push @output, "mov oT0, $viewNormal																								; LINEINFO(JellyFish.vsh)(79)\n";
push @output, "mov oT1, $vTexCoord0																								; LINEINFO(JellyFish.vsh)(80)\n";
