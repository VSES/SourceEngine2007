push @output, "vs.1.1																								; LINEINFO(UnlitGeneric_vs11.vsh)(1)\n";
# STATIC:  "DETAIL"					"0..1"																								
# STATIC:  "ENVMAP"					"0..1"																								
...
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(UnlitGeneric_inc.vsh)(3)\n";
 	 push @output, ";	 $SHADER_SPECIFIC_CONST_0-$SHADER_SPECIFIC_CONST_1 = Base texture transform																								; LINEINFO(UnlitGeneric_inc.vsh)(4)\n";
     push @output, ";    $SHADER_SPECIFIC_CONST_2-$SHADER_SPECIFIC_CONST_3 = Mask texture transform																								; LINEINFO(UnlitGeneric_inc.vsh)(5)\n";
     push @output, ";    $SHADER_SPECIFIC_CONST_4-$SHADER_SPECIFIC_CONST_5 = Detail texture transform																								; LINEINFO(UnlitGeneric_inc.vsh)(6)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(UnlitGeneric_inc.vsh)(7)\n";
sub UnlitGeneric																								
{																								
	local( $detail ) = shift;																								
	local( $envmap ) = shift;																								
	...
	push @output, "	;------------------------------------------------------------------------------																								; LINEINFO(UnlitGeneric_inc.vsh)(57)\n";
	push @output, "	; Texture coordinates (use world-space normal for envmap, tex transform for mask)																								; LINEINFO(UnlitGeneric_inc.vsh)(58)\n";
	push @output, "	;------------------------------------------------------------------------------																								; LINEINFO(UnlitGeneric_inc.vsh)(59)\n";
	push @output, "	dp4 oT0.x, $vTexCoord0, $SHADER_SPECIFIC_CONST_0																								; LINEINFO(UnlitGeneric_inc.vsh)(60)\n";
	push @output, "	dp4 oT0.y, $vTexCoord0, $SHADER_SPECIFIC_CONST_1																								; LINEINFO(UnlitGeneric_inc.vsh)(61)\n";
	if ( $g_x360 )																								
	{																								
		push @output, "		; must write xyzw to match read in pixelshader																								; LINEINFO(UnlitGeneric_inc.vsh)(64)\n";
		push @output, "		mov oT0.zw, $cZero																								; LINEINFO(UnlitGeneric_inc.vsh)(65)\n";
	}																								
	if( $envmap )																								
	{																								
		...
		{																								
			...
			push @output, "			; transform reflection vector into view space																								; LINEINFO(UnlitGeneric_inc.vsh)(75)\n";
			push @output, "			dp3 oT1.x, $reflectionVector, $cViewModel0																								; LINEINFO(UnlitGeneric_inc.vsh)(76)\n";
			push @output, "			dp3 oT1.y, $reflectionVector, $cViewModel1																								; LINEINFO(UnlitGeneric_inc.vsh)(77)\n";
			push @output, "			dp3 oT1.z, $reflectionVector, $cViewModel2																								; LINEINFO(UnlitGeneric_inc.vsh)(78)\n";
			if ( $g_x360 )																								
			{																								
				push @output, "				; must write xyzw to match read in pixelshader																								; LINEINFO(UnlitGeneric_inc.vsh)(81)\n";
				push @output, "				mov oT1.w, $cZero																								; LINEINFO(UnlitGeneric_inc.vsh)(82)\n";
			}																								
		...
		push @output, "		; envmap mask																								; LINEINFO(UnlitGeneric_inc.vsh)(100)\n";
		push @output, "		dp4 oT2.x, $vTexCoord0, $SHADER_SPECIFIC_CONST_2																								; LINEINFO(UnlitGeneric_inc.vsh)(101)\n";
		push @output, "		dp4 oT2.y, $vTexCoord0, $SHADER_SPECIFIC_CONST_3																								; LINEINFO(UnlitGeneric_inc.vsh)(102)\n";
		if ( $g_x360 )																								
		{																								
			push @output, "			; must write xyzw to match read in pixelshader																								; LINEINFO(UnlitGeneric_inc.vsh)(105)\n";
			push @output, "			mov oT2.zw, $cZero																								; LINEINFO(UnlitGeneric_inc.vsh)(106)\n";
		}																								
		&FreeRegister( \$worldPos, "\$worldPos" );																								
	...
	{																								
		...
		{																								
			push @output, "			mov oT3, $vTexCoord1																								; LINEINFO(UnlitGeneric_inc.vsh)(117)\n";
		}																								
		else																								
		{																								
			push @output, "			dp4 oT3.x, $vTexCoord0, $SHADER_SPECIFIC_CONST_4																								; LINEINFO(UnlitGeneric_inc.vsh)(121)\n";
			push @output, "			dp4 oT3.y, $vTexCoord0, $SHADER_SPECIFIC_CONST_5																								; LINEINFO(UnlitGeneric_inc.vsh)(122)\n";
		}																								
		if ( $g_x360 )																								
		{																								
			push @output, "			; must write xyzw to match read in pixelshader																								; LINEINFO(UnlitGeneric_inc.vsh)(127)\n";
			push @output, "			mov oT3.zw, $cZero																								; LINEINFO(UnlitGeneric_inc.vsh)(128)\n";
		}																								
	}																								
	if( $vertexcolor )																								
	{																								
		push @output, "		; Modulation color																								; LINEINFO(UnlitGeneric_inc.vsh)(134)\n";
		push @output, "		mul oD0, $vColor, $cModulationColor																								; LINEINFO(UnlitGeneric_inc.vsh)(135)\n";
	}																								
	else																								
	{																								
		push @output, "		; Modulation color																								; LINEINFO(UnlitGeneric_inc.vsh)(139)\n";
		push @output, "		mov oD0, $cModulationColor																								; LINEINFO(UnlitGeneric_inc.vsh)(140)\n";
	}																								
}																								
