push @output, "vs.1.1																								; LINEINFO(WorldVertexTransition_Seamless.vsh)(1)\n";
...
push @output, "dp4 $projPos.x, $vPos, $cModelViewProj0																								; LINEINFO(WorldVertexTransition_Seamless.vsh)(11)\n";
push @output, "dp4 $projPos.y, $vPos, $cModelViewProj1																								; LINEINFO(WorldVertexTransition_Seamless.vsh)(12)\n";
push @output, "dp4 $projPos.z, $vPos, $cModelViewProj2																								; LINEINFO(WorldVertexTransition_Seamless.vsh)(13)\n";
push @output, "dp4 $projPos.w, $vPos, $cModelViewProj3																								; LINEINFO(WorldVertexTransition_Seamless.vsh)(14)\n";
push @output, "mov oPos, $projPos																								; LINEINFO(WorldVertexTransition_Seamless.vsh)(15)\n";
local( $worldPos ); &AllocateRegister( \$worldPos, "\$worldPos" );
local( $worldNormal ); &AllocateRegister( \$worldNormal, "\$worldNormal" );
push @output, "dp4 $worldPos.x, $vPos, $cModel0																								; LINEINFO(WorldVertexTransition_Seamless.vsh)(20)\n";
push @output, "dp4 $worldPos.y, $vPos, $cModel1																								; LINEINFO(WorldVertexTransition_Seamless.vsh)(21)\n";
push @output, "dp4 $worldPos.z, $vPos, $cModel2																								; LINEINFO(WorldVertexTransition_Seamless.vsh)(22)\n";
push @output, "dp3 $worldNormal.x, $vNormal, $cModel0																								; LINEINFO(WorldVertexTransition_Seamless.vsh)(24)\n";
push @output, "dp3 $worldNormal.y, $vNormal, $cModel1																								; LINEINFO(WorldVertexTransition_Seamless.vsh)(25)\n";
push @output, "dp3 $worldNormal.z, $vNormal, $cModel2																								; LINEINFO(WorldVertexTransition_Seamless.vsh)(26)\n";
&CalcFog( $worldPos, $projPos );																								
&FreeRegister( \$projPos, "\$projPos" );
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(WorldVertexTransition_Seamless.vsh)(32)\n";
push @output, "; Texture coordinates																								; LINEINFO(WorldVertexTransition_Seamless.vsh)(33)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(WorldVertexTransition_Seamless.vsh)(34)\n";
push @output, "; base texcoords																								; LINEINFO(WorldVertexTransition_Seamless.vsh)(35)\n";
local( $texcoord ); &AllocateRegister( \$texcoord, "\$texcoord" );
push @output, "mul $texcoord.xyz, $worldPos, $SHADER_SPECIFIC_CONST_0																								; LINEINFO(WorldVertexTransition_Seamless.vsh)(37)\n";
push @output, "mov oT0.xy, $texcoord.zy;																								; LINEINFO(WorldVertexTransition_Seamless.vsh)(39)\n";
push @output, "mov oT1.xy, $texcoord.xz;																								; LINEINFO(WorldVertexTransition_Seamless.vsh)(40)\n";
push @output, "mov oT2.xy, $texcoord.xy;																								; LINEINFO(WorldVertexTransition_Seamless.vsh)(41)\n";
&FreeRegister( \$texcoord, "\$texcoord" );
push @output, "; lightmap texcoords																								; LINEINFO(WorldVertexTransition_Seamless.vsh)(45)\n";
push @output, "mov oT3, $vTexCoord1																								; LINEINFO(WorldVertexTransition_Seamless.vsh)(46)\n";
push @output, "mul oD0.rgb, $worldNormal, $worldNormal																								; LINEINFO(WorldVertexTransition_Seamless.vsh)(48)\n";
push @output, "; Now the basetexture/basetexture2 blend uses vertex color, so send it into the psh.																								; LINEINFO(WorldVertexTransition_Seamless.vsh)(50)\n";
push @output, "mov oD0.a, $vColor																								; LINEINFO(WorldVertexTransition_Seamless.vsh)(51)\n";
