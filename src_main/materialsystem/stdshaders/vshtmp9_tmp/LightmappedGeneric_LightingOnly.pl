...
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(LightmappedGeneric_LightingOnly.vsh)(7)\n";
 	 push @output, ";	 $SHADER_SPECIFIC_CONST_0-$SHADER_SPECIFIC_CONST_1 = Base texture transform																								; LINEINFO(LightmappedGeneric_LightingOnly.vsh)(8)\n";
     push @output, ";    $SHADER_SPECIFIC_CONST_2-$SHADER_SPECIFIC_CONST_3 = Mask texture transform																								; LINEINFO(LightmappedGeneric_LightingOnly.vsh)(9)\n";
 	 push @output, ";	 $SHADER_SPECIFIC_CONST_4	 = Modulation color 																								; LINEINFO(LightmappedGeneric_LightingOnly.vsh)(10)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(LightmappedGeneric_LightingOnly.vsh)(11)\n";
&AllocateRegister( \$projPos, "\$projPos" );																								
push @output, "; Transform position from object to projection space																								; LINEINFO(LightmappedGeneric_LightingOnly.vsh)(15)\n";
push @output, "dp4 $projPos.x, $vPos, $cModelViewProj0																								; LINEINFO(LightmappedGeneric_LightingOnly.vsh)(16)\n";
push @output, "dp4 $projPos.y, $vPos, $cModelViewProj1																								; LINEINFO(LightmappedGeneric_LightingOnly.vsh)(17)\n";
push @output, "dp4 $projPos.z, $vPos, $cModelViewProj2																								; LINEINFO(LightmappedGeneric_LightingOnly.vsh)(18)\n";
push @output, "dp4 $projPos.w, $vPos, $cModelViewProj3																								; LINEINFO(LightmappedGeneric_LightingOnly.vsh)(19)\n";
push @output, "mov oPos, $projPos																								; LINEINFO(LightmappedGeneric_LightingOnly.vsh)(21)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(LightmappedGeneric_LightingOnly.vsh)(23)\n";
push @output, "; Fog																								; LINEINFO(LightmappedGeneric_LightingOnly.vsh)(24)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(LightmappedGeneric_LightingOnly.vsh)(25)\n";
local( $worldPos ); &AllocateRegister( \$worldPos, "\$worldPos" );
if( $DOWATERFOG == 1 )																								
{																								
	push @output, "	; Get the worldpos z component only since that's all we need for height fog																								; LINEINFO(LightmappedGeneric_LightingOnly.vsh)(30)\n";
	push @output, "	dp4 $worldPos.z, $vPos, $cModel2																								; LINEINFO(LightmappedGeneric_LightingOnly.vsh)(31)\n";
}																								
&CalcFog( $worldPos, $projPos );																								
&FreeRegister( \$worldPos, "\$worldPos" );
&FreeRegister( \$projPos, "\$projPos" );																								
push @output, "; YUCK!  This is to make texcoords continuous for mat_softwaretl																								; LINEINFO(LightmappedGeneric_LightingOnly.vsh)(38)\n";
push @output, "mov oT0, $cZero																								; LINEINFO(LightmappedGeneric_LightingOnly.vsh)(39)\n";
push @output, "; Texture coordinates																								; LINEINFO(LightmappedGeneric_LightingOnly.vsh)(40)\n";
push @output, "mov oT1, $vTexCoord1																								; LINEINFO(LightmappedGeneric_LightingOnly.vsh)(41)\n";
push @output, "mov oD0, $cOne																								; LINEINFO(LightmappedGeneric_LightingOnly.vsh)(43)\n";
