...
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(BumpmappedEnvmap.vsh)(5)\n";
push @output, "; Shader specific constant:																								; LINEINFO(BumpmappedEnvmap.vsh)(6)\n";
 	 push @output, ";	 $SHADER_SPECIFIC_CONST_4, $SHADER_SPECIFIC_CONST_5	= normal map transform																								; LINEINFO(BumpmappedEnvmap.vsh)(7)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(BumpmappedEnvmap.vsh)(8)\n";
...
push @output, "; Vertex blending																								; LINEINFO(BumpmappedEnvmap.vsh)(13)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(BumpmappedEnvmap.vsh)(14)\n";
&AllocateRegister( \$worldPos, "\$worldPos" );																								
push @output, "; Transform position from object to world																								; LINEINFO(BumpmappedEnvmap.vsh)(18)\n";
push @output, "dp4 $worldPos.x, $vPos, $cModel0																								; LINEINFO(BumpmappedEnvmap.vsh)(19)\n";
push @output, "dp4 $worldPos.y, $vPos, $cModel1																								; LINEINFO(BumpmappedEnvmap.vsh)(20)\n";
push @output, "dp4 $worldPos.z, $vPos, $cModel2																								; LINEINFO(BumpmappedEnvmap.vsh)(21)\n";
&AllocateRegister( \$projPos, "\$projPos" );																								
push @output, "; Transform position from object to projection space																								; LINEINFO(BumpmappedEnvmap.vsh)(25)\n";
push @output, "dp4 $projPos.x, $vPos, $cModelViewProj0																								; LINEINFO(BumpmappedEnvmap.vsh)(26)\n";
push @output, "dp4 $projPos.y, $vPos, $cModelViewProj1																								; LINEINFO(BumpmappedEnvmap.vsh)(27)\n";
push @output, "dp4 $projPos.z, $vPos, $cModelViewProj2																								; LINEINFO(BumpmappedEnvmap.vsh)(28)\n";
push @output, "dp4 $projPos.w, $vPos, $cModelViewProj3																								; LINEINFO(BumpmappedEnvmap.vsh)(29)\n";
push @output, "mov oPos, $projPos																								; LINEINFO(BumpmappedEnvmap.vsh)(31)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(BumpmappedEnvmap.vsh)(33)\n";
push @output, "; Lighting																								; LINEINFO(BumpmappedEnvmap.vsh)(34)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(BumpmappedEnvmap.vsh)(35)\n";
push @output, "; Transform tangent space basis vectors to env map space (world space)																								; LINEINFO(BumpmappedEnvmap.vsh)(37)\n";
push @output, "; This will produce a set of vectors mapping from tangent space to env space																								; LINEINFO(BumpmappedEnvmap.vsh)(38)\n";
push @output, "; We'll use this to transform normals from the normal map from tangent space																								; LINEINFO(BumpmappedEnvmap.vsh)(39)\n";
push @output, "; to environment map space. 																								; LINEINFO(BumpmappedEnvmap.vsh)(40)\n";
push @output, "; NOTE: use dp3 here since the basis vectors are vectors, not points																								; LINEINFO(BumpmappedEnvmap.vsh)(41)\n";
push @output, "dp3 oT1.x, $vTangentS, $cModel0																								; LINEINFO(BumpmappedEnvmap.vsh)(43)\n";
push @output, "dp3 oT2.x, $vTangentS, $cModel1																								; LINEINFO(BumpmappedEnvmap.vsh)(44)\n";
push @output, "dp3 oT3.x, $vTangentS, $cModel2																								; LINEINFO(BumpmappedEnvmap.vsh)(45)\n";
push @output, "dp3 oT1.y, $vTangentT, $cModel0																								; LINEINFO(BumpmappedEnvmap.vsh)(47)\n";
push @output, "dp3 oT2.y, $vTangentT, $cModel1																								; LINEINFO(BumpmappedEnvmap.vsh)(48)\n";
push @output, "dp3 oT3.y, $vTangentT, $cModel2																								; LINEINFO(BumpmappedEnvmap.vsh)(49)\n";
push @output, "dp3 oT1.z, $vNormal, $cModel0																								; LINEINFO(BumpmappedEnvmap.vsh)(51)\n";
push @output, "dp3 oT2.z, $vNormal, $cModel1																								; LINEINFO(BumpmappedEnvmap.vsh)(52)\n";
push @output, "dp3 oT3.z, $vNormal, $cModel2																								; LINEINFO(BumpmappedEnvmap.vsh)(53)\n";
&AllocateRegister( \$worldToEye, "\$worldToEye" );																								
push @output, "; Compute the vector from vertex to camera																								; LINEINFO(BumpmappedEnvmap.vsh)(57)\n";
push @output, "sub $worldToEye.xyz, $cEyePos, $worldPos																								; LINEINFO(BumpmappedEnvmap.vsh)(58)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(BumpmappedEnvmap.vsh)(60)\n";
push @output, "; Fog																								; LINEINFO(BumpmappedEnvmap.vsh)(61)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(BumpmappedEnvmap.vsh)(62)\n";
&CalcFog( $worldPos, $projPos );																								
&FreeRegister( \$worldPos, "\$worldPos" );																								
push @output, "; Move it into the w component of the texture coords, as the wacky																								; LINEINFO(BumpmappedEnvmap.vsh)(68)\n";
push @output, "; pixel shader wants it there.																								; LINEINFO(BumpmappedEnvmap.vsh)(69)\n";
push @output, "mov oT1.w, $worldToEye.x																								; LINEINFO(BumpmappedEnvmap.vsh)(70)\n";
push @output, "mov oT2.w, $worldToEye.y																								; LINEINFO(BumpmappedEnvmap.vsh)(71)\n";
push @output, "mov oT3.w, $worldToEye.z																								; LINEINFO(BumpmappedEnvmap.vsh)(72)\n";
&FreeRegister( \$worldToEye, "\$worldToEye" );																								
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(BumpmappedEnvmap.vsh)(76)\n";
push @output, "; Texture coordinates (normal map)																								; LINEINFO(BumpmappedEnvmap.vsh)(77)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(BumpmappedEnvmap.vsh)(78)\n";
push @output, "dp4 oT0.x, $vTexCoord0, $SHADER_SPECIFIC_CONST_4																								; LINEINFO(BumpmappedEnvmap.vsh)(79)\n";
push @output, "dp4 oT0.y, $vTexCoord0, $SHADER_SPECIFIC_CONST_5																								; LINEINFO(BumpmappedEnvmap.vsh)(80)\n";
&FreeRegister( \$projPos, "\$projPos" );																								
