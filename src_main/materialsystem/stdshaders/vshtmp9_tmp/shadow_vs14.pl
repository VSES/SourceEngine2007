...
&AllocateRegister( \$projPos, "\$projPos" );																								
push @output, "dp4 $projPos.x, $vPos, $cViewProj0																								; LINEINFO(shadow_vs14.vsh)(9)\n";
push @output, "dp4 $projPos.y, $vPos, $cViewProj1																								; LINEINFO(shadow_vs14.vsh)(10)\n";
push @output, "dp4 $projPos.z, $vPos, $cViewProj2																								; LINEINFO(shadow_vs14.vsh)(11)\n";
push @output, "dp4 $projPos.w, $vPos, $cViewProj3																								; LINEINFO(shadow_vs14.vsh)(12)\n";
push @output, "mov oPos, $projPos																								; LINEINFO(shadow_vs14.vsh)(13)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(shadow_vs14.vsh)(15)\n";
push @output, "; Fog																								; LINEINFO(shadow_vs14.vsh)(16)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(shadow_vs14.vsh)(17)\n";
local( $worldPos ); &AllocateRegister( \$worldPos, "\$worldPos" );
if( $DOWATERFOG == 1 )																								
{																								
	push @output, "	; Get the worldpos z component only since that's all we need for height fog																								; LINEINFO(shadow_vs14.vsh)(21)\n";
	push @output, "	dp4 $worldPos.z, $vPos, $cModel2																								; LINEINFO(shadow_vs14.vsh)(22)\n";
}																								
&CalcFog( $worldPos, $projPos );																								
&FreeRegister( \$worldPos, "\$worldPos" );
&FreeRegister( \$projPos, "\$projPos" );																								
push @output, "; Shadow color																								; LINEINFO(shadow_vs14.vsh)(29)\n";
push @output, "mov oD0, $vColor																								; LINEINFO(shadow_vs14.vsh)(30)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(shadow_vs14.vsh)(32)\n";
push @output, "; Texture coordinates																								; LINEINFO(shadow_vs14.vsh)(33)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(shadow_vs14.vsh)(34)\n";
push @output, "dp4 r0.x, $vTexCoord0, $SHADER_SPECIFIC_CONST_0																								; LINEINFO(shadow_vs14.vsh)(35)\n";
push @output, "dp4 r0.y, $vTexCoord0, $SHADER_SPECIFIC_CONST_1																								; LINEINFO(shadow_vs14.vsh)(36)\n";
push @output, "; Jittered versions																								; LINEINFO(shadow_vs14.vsh)(38)\n";
push @output, "mov oT0, r0																								; LINEINFO(shadow_vs14.vsh)(39)\n";
push @output, "add oT1, r0, $SHADER_SPECIFIC_CONST_2																								; LINEINFO(shadow_vs14.vsh)(40)\n";
push @output, "sub oT2, r0, $SHADER_SPECIFIC_CONST_2																								; LINEINFO(shadow_vs14.vsh)(41)\n";
push @output, "add oT3, r0, $SHADER_SPECIFIC_CONST_3																								; LINEINFO(shadow_vs14.vsh)(42)\n";
push @output, "sub oT4, r0, $SHADER_SPECIFIC_CONST_3																								; LINEINFO(shadow_vs14.vsh)(43)\n";
