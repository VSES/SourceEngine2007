...
push @output, "mov oPos.xyz, $vPos.xyz																								; LINEINFO(BufferClearObeyStencil_vs11.vsh)(5)\n";
push @output, "mov oPos.w, $cOne																								; LINEINFO(BufferClearObeyStencil_vs11.vsh)(6)\n";
push @output, "mov oD0, $vColor																								; LINEINFO(BufferClearObeyStencil_vs11.vsh)(8)\n";
