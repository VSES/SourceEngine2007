push @output, "vs.1.1																								; LINEINFO(eyes_flashlight_vs11.vsh)(1)\n";
...
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(eyes_flashlight_vs11.vsh)(16)\n";
push @output, "; Transform the position from world to view space																								; LINEINFO(eyes_flashlight_vs11.vsh)(17)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(eyes_flashlight_vs11.vsh)(18)\n";
push @output, "dp4 $projPos.x, $worldPos, $cViewProj0																								; LINEINFO(eyes_flashlight_vs11.vsh)(19)\n";
push @output, "dp4 $projPos.y, $worldPos, $cViewProj1																								; LINEINFO(eyes_flashlight_vs11.vsh)(20)\n";
push @output, "dp4 $projPos.z, $worldPos, $cViewProj2																								; LINEINFO(eyes_flashlight_vs11.vsh)(21)\n";
push @output, "dp4 $projPos.w, $worldPos, $cViewProj3																								; LINEINFO(eyes_flashlight_vs11.vsh)(22)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(eyes_flashlight_vs11.vsh)(24)\n";
push @output, "; Normal is based on vertex position 																								; LINEINFO(eyes_flashlight_vs11.vsh)(25)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(eyes_flashlight_vs11.vsh)(26)\n";
&AllocateRegister( \$worldNormal, "\$worldNormal" );																								
&AllocateRegister( \$normalDotUp, "\$normalDotUp" );																								
push @output, "sub $worldNormal, $worldPos, $SHADER_SPECIFIC_CONST_6		; Normal = (Pos - Eye origin)																								; LINEINFO(eyes_flashlight_vs11.vsh)(30)\n";
push @output, "dp3 $normalDotUp, $worldNormal, $SHADER_SPECIFIC_CONST_7		; Normal -= 0.5f * (Normal dot Eye Up) * Eye Up																								; LINEINFO(eyes_flashlight_vs11.vsh)(31)\n";
push @output, "mul $normalDotUp, $normalDotUp, $cHalf																								; LINEINFO(eyes_flashlight_vs11.vsh)(32)\n";
push @output, "mad $worldNormal, -$normalDotUp, $SHADER_SPECIFIC_CONST_7, $worldNormal																								; LINEINFO(eyes_flashlight_vs11.vsh)(33)\n";
&FreeRegister( \$normalDotUp, "\$normalDotUp" );																								
push @output, "; normalize the normal																								; LINEINFO(eyes_flashlight_vs11.vsh)(37)\n";
&Normalize( $worldNormal );																								
push @output, "mov oPos, $projPos																								; LINEINFO(eyes_flashlight_vs11.vsh)(40)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(eyes_flashlight_vs11.vsh)(42)\n";
push @output, "; Fog																								; LINEINFO(eyes_flashlight_vs11.vsh)(43)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(eyes_flashlight_vs11.vsh)(44)\n";
&CalcFog( $worldPos, $projPos );																								
push @output, "; base tex coords																								; LINEINFO(eyes_flashlight_vs11.vsh)(47)\n";
push @output, "mov oT1.xy, $vTexCoord0																								; LINEINFO(eyes_flashlight_vs11.vsh)(48)\n";
push @output, "; spotlight texcoords																								; LINEINFO(eyes_flashlight_vs11.vsh)(50)\n";
push @output, "dp4 oT0.x, $worldPos, $SHADER_SPECIFIC_CONST_1																								; LINEINFO(eyes_flashlight_vs11.vsh)(51)\n";
push @output, "dp4 oT0.y, $worldPos, $SHADER_SPECIFIC_CONST_2																								; LINEINFO(eyes_flashlight_vs11.vsh)(52)\n";
push @output, "dp4 oT0.z, $worldPos, $SHADER_SPECIFIC_CONST_3																								; LINEINFO(eyes_flashlight_vs11.vsh)(53)\n";
push @output, "dp4 oT0.w, $worldPos, $SHADER_SPECIFIC_CONST_4																								; LINEINFO(eyes_flashlight_vs11.vsh)(54)\n";
...
push @output, "sub $worldPosToLightVector, $SHADER_SPECIFIC_CONST_0.xyz, $worldPos																								; LINEINFO(eyes_flashlight_vs11.vsh)(60)\n";
local( $distatten );																								
local( $distatten ); &AllocateRegister( \$distatten, "\$distatten" );
push @output, "; $distatten = [ 1, 1/dist, 1/distsquared ]																								; LINEINFO(eyes_flashlight_vs11.vsh)(64)\n";
push @output, "; dist squared																								; LINEINFO(eyes_flashlight_vs11.vsh)(66)\n";
push @output, "dp3 $distatten.z, $worldPosToLightVector, $worldPosToLightVector																								; LINEINFO(eyes_flashlight_vs11.vsh)(67)\n";
push @output, "; oodist																								; LINEINFO(eyes_flashlight_vs11.vsh)(69)\n";
push @output, "rsq $distatten.y, $distatten.z																								; LINEINFO(eyes_flashlight_vs11.vsh)(70)\n";
push @output, "mov $distatten.x, $cOne																								; LINEINFO(eyes_flashlight_vs11.vsh)(72)\n";
local( $dist );																								
local( $dist ); &AllocateRegister( \$dist, "\$dist" );
push @output, "mul $dist.x, $distatten.z, $distatten.y																								; LINEINFO(eyes_flashlight_vs11.vsh)(76)\n";
push @output, "rcp $distatten.z, $distatten.z ; 1/distsquared																								; LINEINFO(eyes_flashlight_vs11.vsh)(78)\n";
local( $endFalloffFactor );																								
local( $endFalloffFactor ); &AllocateRegister( \$endFalloffFactor, "\$endFalloffFactor" );
push @output, "; ( dist - farZ )																								; LINEINFO(eyes_flashlight_vs11.vsh)(83)\n";
push @output, "sub $endFalloffFactor.x, $dist.x, $SHADER_SPECIFIC_CONST_5.w																								; LINEINFO(eyes_flashlight_vs11.vsh)(84)\n";
push @output, "; 1 / ( (0.6f * farZ) - farZ)																								; LINEINFO(eyes_flashlight_vs11.vsh)(85)\n";
push @output, "mul $endFalloffFactor, $endFalloffFactor.x, $SHADER_SPECIFIC_CONST_0.w																								; LINEINFO(eyes_flashlight_vs11.vsh)(86)\n";
push @output, "max $endFalloffFactor, $endFalloffFactor, $cZero																								; LINEINFO(eyes_flashlight_vs11.vsh)(87)\n";
push @output, "min $endFalloffFactor, $endFalloffFactor, $cOne																								; LINEINFO(eyes_flashlight_vs11.vsh)(88)\n";
local( $vertAtten );																								
local( $vertAtten ); &AllocateRegister( \$vertAtten, "\$vertAtten" );
push @output, "dp3 $vertAtten, $distatten, $SHADER_SPECIFIC_CONST_5																								; LINEINFO(eyes_flashlight_vs11.vsh)(92)\n";
push @output, "mul $vertAtten, $vertAtten, $endFalloffFactor																								; LINEINFO(eyes_flashlight_vs11.vsh)(93)\n";
push @output, "; Normalize L																								; LINEINFO(eyes_flashlight_vs11.vsh)(95)\n";
&Normalize( $worldPosToLightVector );																								
push @output, "; N.L																								; LINEINFO(eyes_flashlight_vs11.vsh)(98)\n";
push @output, "dp3 $worldNormal, $worldNormal, $worldPosToLightVector																								; LINEINFO(eyes_flashlight_vs11.vsh)(99)\n";
push @output, "; Modulate distance attenuation with N.L																								; LINEINFO(eyes_flashlight_vs11.vsh)(101)\n";
push @output, "mul oD0, $vertAtten, $worldNormal																								; LINEINFO(eyes_flashlight_vs11.vsh)(102)\n";
push @output, "; iris																								; LINEINFO(eyes_flashlight_vs11.vsh)(104)\n";
push @output, "dp4 oT3.x, $SHADER_SPECIFIC_CONST_8, $worldPos																								; LINEINFO(eyes_flashlight_vs11.vsh)(105)\n";
push @output, "dp4 oT3.y, $SHADER_SPECIFIC_CONST_9, $worldPos																								; LINEINFO(eyes_flashlight_vs11.vsh)(106)\n";
