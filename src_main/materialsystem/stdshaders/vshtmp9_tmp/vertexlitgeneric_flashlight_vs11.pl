push @output, "vs.1.1																								; LINEINFO(vertexlitgeneric_flashlight_vs11.vsh)(1)\n";
...
if( 0 )																								
{																								
	push @output, "	; NOTE: Don't do this optimization anymore since it would mean a gazillion combos																								; LINEINFO(vertexlitgeneric_flashlight_vs11.vsh)(17)\n";
	push @output, "	; Special case for static prop lighting.  We can go directly from 																								; LINEINFO(vertexlitgeneric_flashlight_vs11.vsh)(18)\n";
	push @output, "	; world to proj space for position, with the exception of z, which 																								; LINEINFO(vertexlitgeneric_flashlight_vs11.vsh)(19)\n";
	push @output, "	; is needed for fogging *if* height fog is enabled.																								; LINEINFO(vertexlitgeneric_flashlight_vs11.vsh)(20)\n";
	push @output, "	; NOTE: We don't use this path if $envmap is defined since we need																								; LINEINFO(vertexlitgeneric_flashlight_vs11.vsh)(22)\n";
	push @output, "	; worldpos for envmapping.																								; LINEINFO(vertexlitgeneric_flashlight_vs11.vsh)(23)\n";
	push @output, "	dp4 $projPos.x, $vPos, $cModelViewProj0																								; LINEINFO(vertexlitgeneric_flashlight_vs11.vsh)(24)\n";
	push @output, "	dp4 $projPos.y, $vPos, $cModelViewProj1																								; LINEINFO(vertexlitgeneric_flashlight_vs11.vsh)(25)\n";
	push @output, "	dp4 $projPos.z, $vPos, $cModelViewProj2																								; LINEINFO(vertexlitgeneric_flashlight_vs11.vsh)(26)\n";
	push @output, "	dp4 $projPos.w, $vPos, $cModelViewProj3																								; LINEINFO(vertexlitgeneric_flashlight_vs11.vsh)(27)\n";
	push @output, "	; normal																								; LINEINFO(vertexlitgeneric_flashlight_vs11.vsh)(28)\n";
	push @output, "	dp3 $worldNormal.x, $vNormal, $cModel0																								; LINEINFO(vertexlitgeneric_flashlight_vs11.vsh)(29)\n";
	push @output, "	dp3 $worldNormal.y, $vNormal, $cModel1																								; LINEINFO(vertexlitgeneric_flashlight_vs11.vsh)(30)\n";
	push @output, "	dp3 $worldNormal.z, $vNormal, $cModel2																								; LINEINFO(vertexlitgeneric_flashlight_vs11.vsh)(31)\n";
	push @output, "	; Need this for height fog if it's enabled and for height clipping																								; LINEINFO(vertexlitgeneric_flashlight_vs11.vsh)(33)\n";
	push @output, "	dp4 $worldPos.z, $vPos, $cModel2																								; LINEINFO(vertexlitgeneric_flashlight_vs11.vsh)(34)\n";
}																								
else																								
{																								
	...
	push @output, "	;------------------------------------------------------------------------------																								; LINEINFO(vertexlitgeneric_flashlight_vs11.vsh)(45)\n";
	push @output, "	; Transform the position from world to view space																								; LINEINFO(vertexlitgeneric_flashlight_vs11.vsh)(46)\n";
	push @output, "	;------------------------------------------------------------------------------																								; LINEINFO(vertexlitgeneric_flashlight_vs11.vsh)(47)\n";
	push @output, "	dp4 $projPos.x, $worldPos, $cViewProj0																								; LINEINFO(vertexlitgeneric_flashlight_vs11.vsh)(48)\n";
	push @output, "	dp4 $projPos.y, $worldPos, $cViewProj1																								; LINEINFO(vertexlitgeneric_flashlight_vs11.vsh)(49)\n";
	push @output, "	dp4 $projPos.z, $worldPos, $cViewProj2																								; LINEINFO(vertexlitgeneric_flashlight_vs11.vsh)(50)\n";
	push @output, "	dp4 $projPos.w, $worldPos, $cViewProj3																								; LINEINFO(vertexlitgeneric_flashlight_vs11.vsh)(51)\n";
}																								
push @output, "mov oPos, $projPos																								; LINEINFO(vertexlitgeneric_flashlight_vs11.vsh)(54)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(vertexlitgeneric_flashlight_vs11.vsh)(56)\n";
push @output, "; Fog																								; LINEINFO(vertexlitgeneric_flashlight_vs11.vsh)(57)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(vertexlitgeneric_flashlight_vs11.vsh)(58)\n";
&CalcFog( $worldPos, $projPos );																								
push @output, "; base tex coords																								; LINEINFO(vertexlitgeneric_flashlight_vs11.vsh)(61)\n";
push @output, "dp4 oT1.x, $vTexCoord0, $SHADER_SPECIFIC_CONST_6																								; LINEINFO(vertexlitgeneric_flashlight_vs11.vsh)(62)\n";
push @output, "dp4 oT1.y, $vTexCoord0, $SHADER_SPECIFIC_CONST_7																								; LINEINFO(vertexlitgeneric_flashlight_vs11.vsh)(63)\n";
push @output, "; normal map coords																								; LINEINFO(vertexlitgeneric_flashlight_vs11.vsh)(65)\n";
push @output, ";dp4 oT3.x, $vTexCoord0, $SHADER_SPECIFIC_CONST_8																								; LINEINFO(vertexlitgeneric_flashlight_vs11.vsh)(66)\n";
push @output, ";dp4 oT3.y, $vTexCoord0, $SHADER_SPECIFIC_CONST_9																								; LINEINFO(vertexlitgeneric_flashlight_vs11.vsh)(67)\n";
push @output, "; spotlight texcoords																								; LINEINFO(vertexlitgeneric_flashlight_vs11.vsh)(69)\n";
push @output, "dp4 oT0.x, $worldPos, $SHADER_SPECIFIC_CONST_1																								; LINEINFO(vertexlitgeneric_flashlight_vs11.vsh)(70)\n";
push @output, "dp4 oT0.y, $worldPos, $SHADER_SPECIFIC_CONST_2																								; LINEINFO(vertexlitgeneric_flashlight_vs11.vsh)(71)\n";
push @output, "dp4 oT0.z, $worldPos, $SHADER_SPECIFIC_CONST_3																								; LINEINFO(vertexlitgeneric_flashlight_vs11.vsh)(72)\n";
push @output, "dp4 oT0.w, $worldPos, $SHADER_SPECIFIC_CONST_4																								; LINEINFO(vertexlitgeneric_flashlight_vs11.vsh)(73)\n";
...
push @output, "sub $worldPosToLightVector, $SHADER_SPECIFIC_CONST_0, $worldPos																								; LINEINFO(vertexlitgeneric_flashlight_vs11.vsh)(79)\n";
push @output, "mov oT2, $worldPosToLightVector																								; LINEINFO(vertexlitgeneric_flashlight_vs11.vsh)(80)\n";
local( $distatten );																								
local( $distatten ); &AllocateRegister( \$distatten, "\$distatten" );
push @output, "; $distatten = [ 1, 1/dist, 1/distsquared ]																								; LINEINFO(vertexlitgeneric_flashlight_vs11.vsh)(84)\n";
push @output, "; dist squared																								; LINEINFO(vertexlitgeneric_flashlight_vs11.vsh)(86)\n";
push @output, "dp3 $distatten.z, $worldPosToLightVector, $worldPosToLightVector																								; LINEINFO(vertexlitgeneric_flashlight_vs11.vsh)(87)\n";
push @output, "; oodist																								; LINEINFO(vertexlitgeneric_flashlight_vs11.vsh)(89)\n";
push @output, "rsq $distatten.y, $distatten.z																								; LINEINFO(vertexlitgeneric_flashlight_vs11.vsh)(90)\n";
push @output, "mov $distatten.x, $cOne																								; LINEINFO(vertexlitgeneric_flashlight_vs11.vsh)(92)\n";
local( $dist );																								
local( $dist ); &AllocateRegister( \$dist, "\$dist" );
push @output, "mul $dist.x, $distatten.z, $distatten.y																								; LINEINFO(vertexlitgeneric_flashlight_vs11.vsh)(96)\n";
push @output, "rcp $distatten.z, $distatten.z ; 1/distsquared																								; LINEINFO(vertexlitgeneric_flashlight_vs11.vsh)(98)\n";
local( $endFalloffFactor );																								
local( $endFalloffFactor ); &AllocateRegister( \$endFalloffFactor, "\$endFalloffFactor" );
push @output, "; ( dist - farZ )																								; LINEINFO(vertexlitgeneric_flashlight_vs11.vsh)(103)\n";
push @output, "sub $endFalloffFactor.x, $dist.x, $SHADER_SPECIFIC_CONST_5.w																								; LINEINFO(vertexlitgeneric_flashlight_vs11.vsh)(104)\n";
push @output, "; 1 / ( (0.6f * farZ) - farZ)																								; LINEINFO(vertexlitgeneric_flashlight_vs11.vsh)(105)\n";
push @output, "mul $endFalloffFactor, $endFalloffFactor.x, $SHADER_SPECIFIC_CONST_0.w																								; LINEINFO(vertexlitgeneric_flashlight_vs11.vsh)(106)\n";
push @output, "max $endFalloffFactor, $endFalloffFactor, $cZero																								; LINEINFO(vertexlitgeneric_flashlight_vs11.vsh)(107)\n";
push @output, "min $endFalloffFactor, $endFalloffFactor, $cOne																								; LINEINFO(vertexlitgeneric_flashlight_vs11.vsh)(108)\n";
local( $vertAtten );																								
local( $vertAtten ); &AllocateRegister( \$vertAtten, "\$vertAtten" );
push @output, "dp3 $vertAtten, $distatten, $SHADER_SPECIFIC_CONST_5																								; LINEINFO(vertexlitgeneric_flashlight_vs11.vsh)(112)\n";
push @output, "mul $vertAtten, $vertAtten, $endFalloffFactor																								; LINEINFO(vertexlitgeneric_flashlight_vs11.vsh)(113)\n";
if( $TEETH )																								
{																								
	local( $mouthAtten ); &AllocateRegister( \$mouthAtten, "\$mouthAtten" );
	push @output, "	dp3 $mouthAtten, $worldNormal.xyz, $SHADER_SPECIFIC_CONST_10.xyz																								; LINEINFO(vertexlitgeneric_flashlight_vs11.vsh)(118)\n";
	push @output, "	max $mouthAtten, $cZero, $mouthAtten																								; LINEINFO(vertexlitgeneric_flashlight_vs11.vsh)(119)\n";
	push @output, "	mul $mouthAtten, $mouthAtten, $SHADER_SPECIFIC_CONST_10.w																								; LINEINFO(vertexlitgeneric_flashlight_vs11.vsh)(120)\n";
	push @output, "	mul $vertAtten, $vertAtten, $mouthAtten																								; LINEINFO(vertexlitgeneric_flashlight_vs11.vsh)(121)\n";
	&FreeRegister( \$mouthAtten, "\$mouthAtten" );
}																								
push @output, "mov oD0, $vertAtten																								; LINEINFO(vertexlitgeneric_flashlight_vs11.vsh)(125)\n";
push @output, "mov oT3.xyz, $worldNormal.xyz																								; LINEINFO(vertexlitgeneric_flashlight_vs11.vsh)(127)\n";
