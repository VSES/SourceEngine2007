push @output, "vs.1.1																								; LINEINFO(WorldVertexTransition_vs14.vsh)(1)\n";
...
&AllocateRegister( \$projPos, "\$projPos" );																								
push @output, "dp4 $projPos.x, $vPos, $cModelViewProj0																								; LINEINFO(WorldVertexTransition_vs14.vsh)(11)\n";
push @output, "dp4 $projPos.y, $vPos, $cModelViewProj1																								; LINEINFO(WorldVertexTransition_vs14.vsh)(12)\n";
push @output, "dp4 $projPos.z, $vPos, $cModelViewProj2																								; LINEINFO(WorldVertexTransition_vs14.vsh)(13)\n";
push @output, "dp4 $projPos.w, $vPos, $cModelViewProj3																								; LINEINFO(WorldVertexTransition_vs14.vsh)(14)\n";
push @output, "mov oPos, $projPos																								; LINEINFO(WorldVertexTransition_vs14.vsh)(15)\n";
&AllocateRegister( \$worldPos, "\$worldPos" );																								
push @output, "; garymcthack																								; LINEINFO(WorldVertexTransition_vs14.vsh)(19)\n";
push @output, "dp4 $worldPos.z, $vPos, $cModel2																								; LINEINFO(WorldVertexTransition_vs14.vsh)(20)\n";
&CalcFog( $worldPos, $projPos );																								
&FreeRegister( \$worldPos, "\$worldPos" );																								
&FreeRegister( \$projPos, "\$projPos" );																								
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(WorldVertexTransition_vs14.vsh)(27)\n";
push @output, "; Texture coordinates																								; LINEINFO(WorldVertexTransition_vs14.vsh)(28)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(WorldVertexTransition_vs14.vsh)(29)\n";
push @output, "; base texcoords																								; LINEINFO(WorldVertexTransition_vs14.vsh)(30)\n";
push @output, "dp4 oT0.x, $vTexCoord0, $SHADER_SPECIFIC_CONST_0																								; LINEINFO(WorldVertexTransition_vs14.vsh)(31)\n";
push @output, "dp4 oT0.y, $vTexCoord0, $SHADER_SPECIFIC_CONST_1																								; LINEINFO(WorldVertexTransition_vs14.vsh)(32)\n";
push @output, "dp4 oT1.x, $vTexCoord0, $SHADER_SPECIFIC_CONST_2																								; LINEINFO(WorldVertexTransition_vs14.vsh)(34)\n";
push @output, "dp4 oT1.y, $vTexCoord0, $SHADER_SPECIFIC_CONST_3																								; LINEINFO(WorldVertexTransition_vs14.vsh)(35)\n";
push @output, "; lightmap texcoords																								; LINEINFO(WorldVertexTransition_vs14.vsh)(37)\n";
push @output, "mov oT2, $vTexCoord1																								; LINEINFO(WorldVertexTransition_vs14.vsh)(38)\n";
push @output, "; detail																								; LINEINFO(WorldVertexTransition_vs14.vsh)(40)\n";
push @output, "dp4 oT3.x, $vTexCoord0, $SHADER_SPECIFIC_CONST_4																								; LINEINFO(WorldVertexTransition_vs14.vsh)(41)\n";
push @output, "dp4 oT3.y, $vTexCoord0, $SHADER_SPECIFIC_CONST_5																								; LINEINFO(WorldVertexTransition_vs14.vsh)(42)\n";
push @output, "; mask																								; LINEINFO(WorldVertexTransition_vs14.vsh)(44)\n";
push @output, "dp4 oT4.x, $vTexCoord0, $SHADER_SPECIFIC_CONST_6																								; LINEINFO(WorldVertexTransition_vs14.vsh)(45)\n";
push @output, "dp4 oT4.y, $vTexCoord0, $SHADER_SPECIFIC_CONST_7																								; LINEINFO(WorldVertexTransition_vs14.vsh)(46)\n";
push @output, "; Now the basetexture/basetexture2 blend uses vertex color, so send it into the psh.																								; LINEINFO(WorldVertexTransition_vs14.vsh)(48)\n";
push @output, "mov oD0, $vColor																								; LINEINFO(WorldVertexTransition_vs14.vsh)(49)\n";
