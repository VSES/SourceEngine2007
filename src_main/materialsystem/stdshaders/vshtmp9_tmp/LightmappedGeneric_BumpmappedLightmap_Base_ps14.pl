push @output, "vs.1.1																								; LINEINFO(LightmappedGeneric_BumpmappedLightmap_Base_ps14.vsh)(1)\n";
...
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(LightmappedGeneric_BumpmappedLightmap_Base_ps14.vsh)(7)\n";
push @output, "; Vertex blending																								; LINEINFO(LightmappedGeneric_BumpmappedLightmap_Base_ps14.vsh)(8)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(LightmappedGeneric_BumpmappedLightmap_Base_ps14.vsh)(9)\n";
&AllocateRegister( \$projPos, "\$projPos" );																								
push @output, "; Transform position from object to projection space																								; LINEINFO(LightmappedGeneric_BumpmappedLightmap_Base_ps14.vsh)(13)\n";
push @output, "dp4 $projPos.x, $vPos, $cModelViewProj0																								; LINEINFO(LightmappedGeneric_BumpmappedLightmap_Base_ps14.vsh)(14)\n";
push @output, "dp4 $projPos.y, $vPos, $cModelViewProj1																								; LINEINFO(LightmappedGeneric_BumpmappedLightmap_Base_ps14.vsh)(15)\n";
push @output, "dp4 $projPos.z, $vPos, $cModelViewProj2																								; LINEINFO(LightmappedGeneric_BumpmappedLightmap_Base_ps14.vsh)(16)\n";
push @output, "dp4 $projPos.w, $vPos, $cModelViewProj3																								; LINEINFO(LightmappedGeneric_BumpmappedLightmap_Base_ps14.vsh)(17)\n";
push @output, "mov oPos, $projPos																								; LINEINFO(LightmappedGeneric_BumpmappedLightmap_Base_ps14.vsh)(19)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(LightmappedGeneric_BumpmappedLightmap_Base_ps14.vsh)(21)\n";
push @output, "; Fog																								; LINEINFO(LightmappedGeneric_BumpmappedLightmap_Base_ps14.vsh)(22)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(LightmappedGeneric_BumpmappedLightmap_Base_ps14.vsh)(23)\n";
local( $worldPos ); &AllocateRegister( \$worldPos, "\$worldPos" );
if( $DOWATERFOG == 1 )																								
{																								
	push @output, "	; Get the worldpos z component only since that's all we need for height fog																								; LINEINFO(LightmappedGeneric_BumpmappedLightmap_Base_ps14.vsh)(28)\n";
	push @output, "	dp4 $worldPos.z, $vPos, $cModel2																								; LINEINFO(LightmappedGeneric_BumpmappedLightmap_Base_ps14.vsh)(29)\n";
}																								
&CalcFog( $worldPos, $projPos );																								
&FreeRegister( \$worldPos, "\$worldPos" );
&FreeRegister( \$projPos, "\$projPos" );																								
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(LightmappedGeneric_BumpmappedLightmap_Base_ps14.vsh)(36)\n";
push @output, "; Texture coordinates																								; LINEINFO(LightmappedGeneric_BumpmappedLightmap_Base_ps14.vsh)(37)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(LightmappedGeneric_BumpmappedLightmap_Base_ps14.vsh)(38)\n";
push @output, "; Compute the texture coordinates given the offset between																								; LINEINFO(LightmappedGeneric_BumpmappedLightmap_Base_ps14.vsh)(40)\n";
push @output, "; each bumped lightmap																								; LINEINFO(LightmappedGeneric_BumpmappedLightmap_Base_ps14.vsh)(41)\n";
&AllocateRegister( \$offset, "\$offset" );																								
push @output, "mov $offset.xy, $vTexCoord2																								; LINEINFO(LightmappedGeneric_BumpmappedLightmap_Base_ps14.vsh)(43)\n";
push @output, "dp4 oT0.x, $vTexCoord0, $SHADER_SPECIFIC_CONST_0																								; LINEINFO(LightmappedGeneric_BumpmappedLightmap_Base_ps14.vsh)(44)\n";
push @output, "dp4 oT0.y, $vTexCoord0, $SHADER_SPECIFIC_CONST_1																								; LINEINFO(LightmappedGeneric_BumpmappedLightmap_Base_ps14.vsh)(45)\n";
push @output, "add oT1.xy, $offset, $vTexCoord1																								; LINEINFO(LightmappedGeneric_BumpmappedLightmap_Base_ps14.vsh)(46)\n";
push @output, "mad oT2.xy, $offset, $cTwo, $vTexCoord1																								; LINEINFO(LightmappedGeneric_BumpmappedLightmap_Base_ps14.vsh)(47)\n";
local( $three ); &AllocateRegister( \$three, "\$three" );
push @output, "add $three, $cOne, $cTwo																								; LINEINFO(LightmappedGeneric_BumpmappedLightmap_Base_ps14.vsh)(49)\n";
push @output, "mad oT3.xy, $offset, $three, $vTexCoord1																								; LINEINFO(LightmappedGeneric_BumpmappedLightmap_Base_ps14.vsh)(50)\n";
&FreeRegister( \$three, "\$three" );
push @output, "dp4 oT4.x, $vTexCoord0, $SHADER_SPECIFIC_CONST_2																								; LINEINFO(LightmappedGeneric_BumpmappedLightmap_Base_ps14.vsh)(52)\n";
push @output, "dp4 oT4.y, $vTexCoord0, $SHADER_SPECIFIC_CONST_3																								; LINEINFO(LightmappedGeneric_BumpmappedLightmap_Base_ps14.vsh)(53)\n";
