...
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(VertexLitGeneric_SelfIllumOnly.vsh)(8)\n";
push @output, "; Vertex blending																								; LINEINFO(VertexLitGeneric_SelfIllumOnly.vsh)(9)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(VertexLitGeneric_SelfIllumOnly.vsh)(10)\n";
&AllocateRegister( \$worldPos, "\$worldPos" );																								
&SkinPosition( $worldPos );																								
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(VertexLitGeneric_SelfIllumOnly.vsh)(14)\n";
push @output, "; Transform the position from world to view space																								; LINEINFO(VertexLitGeneric_SelfIllumOnly.vsh)(15)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(VertexLitGeneric_SelfIllumOnly.vsh)(16)\n";
&AllocateRegister( \$projPos, "\$projPos" );																								
push @output, "dp4 $projPos.x, $worldPos, $cViewProj0																								; LINEINFO(VertexLitGeneric_SelfIllumOnly.vsh)(20)\n";
push @output, "dp4 $projPos.y, $worldPos, $cViewProj1																								; LINEINFO(VertexLitGeneric_SelfIllumOnly.vsh)(21)\n";
push @output, "dp4 $projPos.z, $worldPos, $cViewProj2																								; LINEINFO(VertexLitGeneric_SelfIllumOnly.vsh)(22)\n";
push @output, "dp4 $projPos.w, $worldPos, $cViewProj3																								; LINEINFO(VertexLitGeneric_SelfIllumOnly.vsh)(23)\n";
push @output, "mov oPos, $projPos																								; LINEINFO(VertexLitGeneric_SelfIllumOnly.vsh)(24)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(VertexLitGeneric_SelfIllumOnly.vsh)(26)\n";
push @output, "; Fog																								; LINEINFO(VertexLitGeneric_SelfIllumOnly.vsh)(27)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(VertexLitGeneric_SelfIllumOnly.vsh)(28)\n";
&CalcFog( $worldPos, $projPos );																								
&FreeRegister( \$projPos, "\$projPos" );																								
&FreeRegister( \$worldPos, "\$worldPos" );																								
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(VertexLitGeneric_SelfIllumOnly.vsh)(34)\n";
push @output, "; Texture coordinates																								; LINEINFO(VertexLitGeneric_SelfIllumOnly.vsh)(35)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(VertexLitGeneric_SelfIllumOnly.vsh)(36)\n";
push @output, "dp4 oT0.x, $vTexCoord0, $SHADER_SPECIFIC_CONST_0																								; LINEINFO(VertexLitGeneric_SelfIllumOnly.vsh)(38)\n";
push @output, "dp4 oT0.y, $vTexCoord0, $SHADER_SPECIFIC_CONST_1																								; LINEINFO(VertexLitGeneric_SelfIllumOnly.vsh)(39)\n";
