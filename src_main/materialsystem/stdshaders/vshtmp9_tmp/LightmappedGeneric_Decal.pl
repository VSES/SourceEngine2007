push @output, "vs.1.1																								; LINEINFO(LightmappedGeneric_Decal.vsh)(1)\n";
...
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(LightmappedGeneric_Decal.vsh)(7)\n";
push @output, "; Vertex blending																								; LINEINFO(LightmappedGeneric_Decal.vsh)(8)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(LightmappedGeneric_Decal.vsh)(9)\n";
&AllocateRegister( \$projPos, "\$projPos" );																								
push @output, "; Transform position from object to projection space																								; LINEINFO(LightmappedGeneric_Decal.vsh)(13)\n";
push @output, "dp4 $projPos.x, $vPos, $cModelViewProj0																								; LINEINFO(LightmappedGeneric_Decal.vsh)(14)\n";
push @output, "dp4 $projPos.y, $vPos, $cModelViewProj1																								; LINEINFO(LightmappedGeneric_Decal.vsh)(15)\n";
push @output, "dp4 $projPos.z, $vPos, $cModelViewProj2																								; LINEINFO(LightmappedGeneric_Decal.vsh)(16)\n";
push @output, "dp4 $projPos.w, $vPos, $cModelViewProj3																								; LINEINFO(LightmappedGeneric_Decal.vsh)(17)\n";
push @output, "mov oPos, $projPos																								; LINEINFO(LightmappedGeneric_Decal.vsh)(19)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(LightmappedGeneric_Decal.vsh)(21)\n";
push @output, "; Fog																								; LINEINFO(LightmappedGeneric_Decal.vsh)(22)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(LightmappedGeneric_Decal.vsh)(23)\n";
local( $worldPos ); &AllocateRegister( \$worldPos, "\$worldPos" );
if( $DOWATERFOG == 1 )																								
{																								
	push @output, "	; Get the worldpos z component only since that's all we need for height fog																								; LINEINFO(LightmappedGeneric_Decal.vsh)(28)\n";
	push @output, "	dp4 $worldPos.z, $vPos, $cModel2																								; LINEINFO(LightmappedGeneric_Decal.vsh)(29)\n";
}																								
&CalcFog( $worldPos, $projPos );																								
&FreeRegister( \$worldPos, "\$worldPos" );
&FreeRegister( \$projPos, "\$projPos" );																								
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(LightmappedGeneric_Decal.vsh)(36)\n";
push @output, "; Texture coordinates																								; LINEINFO(LightmappedGeneric_Decal.vsh)(37)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(LightmappedGeneric_Decal.vsh)(38)\n";
push @output, "; Compute the texture coordinates given the offset between																								; LINEINFO(LightmappedGeneric_Decal.vsh)(40)\n";
push @output, "; each bumped lightmap																								; LINEINFO(LightmappedGeneric_Decal.vsh)(41)\n";
&AllocateRegister( \$offset, "\$offset" );																								
push @output, "mov $offset.x, $vTexCoord2.x																								; LINEINFO(LightmappedGeneric_Decal.vsh)(43)\n";
push @output, "mov $offset.y, $cZero																								; LINEINFO(LightmappedGeneric_Decal.vsh)(44)\n";
push @output, "dp4 oT0.x, $vTexCoord0, $SHADER_SPECIFIC_CONST_0																								; LINEINFO(LightmappedGeneric_Decal.vsh)(45)\n";
push @output, "dp4 oT0.y, $vTexCoord0, $SHADER_SPECIFIC_CONST_1																								; LINEINFO(LightmappedGeneric_Decal.vsh)(46)\n";
push @output, "add oT1.xy, $offset, $vTexCoord1																								; LINEINFO(LightmappedGeneric_Decal.vsh)(47)\n";
push @output, "mad oT2.xy, $offset, $cTwo, $vTexCoord1																								; LINEINFO(LightmappedGeneric_Decal.vsh)(48)\n";
push @output, "; make a 3																								; LINEINFO(LightmappedGeneric_Decal.vsh)(49)\n";
local( $three ); &AllocateRegister( \$three, "\$three" );
push @output, "add $three, $cOne, $cTwo																								; LINEINFO(LightmappedGeneric_Decal.vsh)(51)\n";
push @output, "mad oT3.xy, $offset, $three, $vTexCoord1																								; LINEINFO(LightmappedGeneric_Decal.vsh)(52)\n";
&FreeRegister( \$three, "\$three" );
push @output, "mov oD0, $vColor																								; LINEINFO(LightmappedGeneric_Decal.vsh)(54)\n";
