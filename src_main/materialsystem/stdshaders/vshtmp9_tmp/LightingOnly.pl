...
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(LightingOnly.vsh)(10)\n";
push @output, "; Vertex blending 																								; LINEINFO(LightingOnly.vsh)(11)\n";
...
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(LightingOnly.vsh)(17)\n";
push @output, "; Transform the position from model to proj																								; LINEINFO(LightingOnly.vsh)(18)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(LightingOnly.vsh)(19)\n";
&AllocateRegister( \$projPos, "\$projPos" );																								
push @output, "dp4 $projPos.x, $worldPos, $cViewProj0																								; LINEINFO(LightingOnly.vsh)(23)\n";
push @output, "dp4 $projPos.y, $worldPos, $cViewProj1																								; LINEINFO(LightingOnly.vsh)(24)\n";
push @output, "dp4 $projPos.z, $worldPos, $cViewProj2																								; LINEINFO(LightingOnly.vsh)(25)\n";
push @output, "dp4 $projPos.w, $worldPos, $cViewProj3																								; LINEINFO(LightingOnly.vsh)(26)\n";
push @output, "mov oPos, $projPos																								; LINEINFO(LightingOnly.vsh)(27)\n";
&CalcFog( $worldPos, $projPos );																								
&FreeRegister( \$projPos, "\$projPos" );																								
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(LightingOnly.vsh)(33)\n";
push @output, "; Lighting																								; LINEINFO(LightingOnly.vsh)(34)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(LightingOnly.vsh)(35)\n";
