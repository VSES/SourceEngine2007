...
push @output, "; Vertex blending																								; LINEINFO(lightmappedgeneric_basetextureblend.vsh)(8)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(lightmappedgeneric_basetextureblend.vsh)(9)\n";
&AllocateRegister( \$projPos, "\$projPos" );																								
push @output, "dp4 $projPos.x, $vPos, $cModelViewProj0																								; LINEINFO(lightmappedgeneric_basetextureblend.vsh)(13)\n";
push @output, "dp4 $projPos.y, $vPos, $cModelViewProj1																								; LINEINFO(lightmappedgeneric_basetextureblend.vsh)(14)\n";
push @output, "dp4 $projPos.z, $vPos, $cModelViewProj2																								; LINEINFO(lightmappedgeneric_basetextureblend.vsh)(15)\n";
push @output, "dp4 $projPos.w, $vPos, $cModelViewProj3																								; LINEINFO(lightmappedgeneric_basetextureblend.vsh)(16)\n";
push @output, "mov oPos, $projPos																								; LINEINFO(lightmappedgeneric_basetextureblend.vsh)(17)\n";
local( $worldPos ); &AllocateRegister( \$worldPos, "\$worldPos" );
if( $DOWATERFOG == 1 )																								
{																								
	push @output, "	; Get the worldpos z component only since that's all we need for height fog																								; LINEINFO(lightmappedgeneric_basetextureblend.vsh)(22)\n";
	push @output, "	dp4 $worldPos.z, $vPos, $cModel2																								; LINEINFO(lightmappedgeneric_basetextureblend.vsh)(23)\n";
}																								
&CalcFog( $worldPos, $projPos );																								
&FreeRegister( \$worldPos, "\$worldPos" );
&FreeRegister( \$projPos, "\$projPos" );																								
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(lightmappedgeneric_basetextureblend.vsh)(30)\n";
push @output, "; Texture coordinates																								; LINEINFO(lightmappedgeneric_basetextureblend.vsh)(31)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(lightmappedgeneric_basetextureblend.vsh)(32)\n";
push @output, "dp4 oT0.x, $vTexCoord0, $SHADER_SPECIFIC_CONST_0																								; LINEINFO(lightmappedgeneric_basetextureblend.vsh)(34)\n";
push @output, "dp4 oT0.y, $vTexCoord0, $SHADER_SPECIFIC_CONST_1																								; LINEINFO(lightmappedgeneric_basetextureblend.vsh)(35)\n";
push @output, "dp4 oT1.x, $vTexCoord0, $SHADER_SPECIFIC_CONST_2																								; LINEINFO(lightmappedgeneric_basetextureblend.vsh)(37)\n";
push @output, "dp4 oT1.y, $vTexCoord0, $SHADER_SPECIFIC_CONST_3																								; LINEINFO(lightmappedgeneric_basetextureblend.vsh)(38)\n";
push @output, "mov oT2, $vTexCoord1																								; LINEINFO(lightmappedgeneric_basetextureblend.vsh)(40)\n";
push @output, "; Now the basetexture/basetexture2 blend uses vertex color, so send it into the psh.																								; LINEINFO(lightmappedgeneric_basetextureblend.vsh)(42)\n";
push @output, "mov oD0, $vColor																								; LINEINFO(lightmappedgeneric_basetextureblend.vsh)(43)\n";
