...
push @output, "; Transform the position from world to view space																								; LINEINFO(UnlitGeneric_LightingOnly.vsh)(11)\n";
push @output, "dp4 oPos.x, $worldPos, $cViewProj0																								; LINEINFO(UnlitGeneric_LightingOnly.vsh)(12)\n";
push @output, "dp4 oPos.y, $worldPos, $cViewProj1																								; LINEINFO(UnlitGeneric_LightingOnly.vsh)(13)\n";
push @output, "dp4 oPos.z, $worldPos, $cViewProj2																								; LINEINFO(UnlitGeneric_LightingOnly.vsh)(14)\n";
push @output, "dp4 oPos.w, $worldPos, $cViewProj3																								; LINEINFO(UnlitGeneric_LightingOnly.vsh)(15)\n";
&FreeRegister( \$worldPos, "\$worldPos" );																								
push @output, "mov oD0, $cOne																								; LINEINFO(UnlitGeneric_LightingOnly.vsh)(19)\n";
