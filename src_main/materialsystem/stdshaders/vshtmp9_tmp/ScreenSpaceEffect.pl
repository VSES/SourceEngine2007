...
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(ScreenSpaceEffect.vsh)(5)\n";
push @output, "; Constants specified by the app																								; LINEINFO(ScreenSpaceEffect.vsh)(6)\n";
     push @output, ";    c0      = (0, 1, 2, 0.5)																								; LINEINFO(ScreenSpaceEffect.vsh)(7)\n";
 	 push @output, ";	 c1		 = (1/2.2, 3, 255, overbright factor)																								; LINEINFO(ScreenSpaceEffect.vsh)(8)\n";
     push @output, ";    c2      = camera position *in world space*																								; LINEINFO(ScreenSpaceEffect.vsh)(9)\n";
     push @output, ";    c4-c7   = modelViewProj matrix	(transpose)																								; LINEINFO(ScreenSpaceEffect.vsh)(10)\n";
     push @output, ";    c8-c11  = ViewProj matrix (transpose)																								; LINEINFO(ScreenSpaceEffect.vsh)(11)\n";
     push @output, ";    c12-c15 = model->view matrix (transpose)																								; LINEINFO(ScreenSpaceEffect.vsh)(12)\n";
 	 push @output, ";	 c16	 = [fogStart, fogEnd, fogRange, 1.0/fogRange]																								; LINEINFO(ScreenSpaceEffect.vsh)(13)\n";
 	 push @output, ";	 $SHADER_SPECIFIC_CONST_0-$SHADER_SPECIFIC_CONST_1 = Base texture transform																								; LINEINFO(ScreenSpaceEffect.vsh)(14)\n";
     push @output, ";    $SHADER_SPECIFIC_CONST_2-$SHADER_SPECIFIC_CONST_3 = Mask texture transform																								; LINEINFO(ScreenSpaceEffect.vsh)(15)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(ScreenSpaceEffect.vsh)(16)\n";
...
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(ScreenSpaceEffect.vsh)(20)\n";
push @output, "; No vertex blending required. Input vertex data is in screen space																								; LINEINFO(ScreenSpaceEffect.vsh)(21)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(ScreenSpaceEffect.vsh)(22)\n";
push @output, "mov oPos.xyz, $vPos.xyz																								; LINEINFO(ScreenSpaceEffect.vsh)(23)\n";
push @output, "mov oPos.w, $cOne																								; LINEINFO(ScreenSpaceEffect.vsh)(24)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(ScreenSpaceEffect.vsh)(26)\n";
push @output, "; Pass any and all texture coordinates through																								; LINEINFO(ScreenSpaceEffect.vsh)(27)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(ScreenSpaceEffect.vsh)(28)\n";
push @output, "mov	oT0, $vTexCoord0																								; LINEINFO(ScreenSpaceEffect.vsh)(29)\n";
