...
push @output, "; Vertex blending																								; LINEINFO(BumpmappedLightmap.vsh)(8)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(BumpmappedLightmap.vsh)(9)\n";
local( $projPos ); &AllocateRegister( \$projPos, "\$projPos" );
push @output, "; Transform position from object to projection space																								; LINEINFO(BumpmappedLightmap.vsh)(13)\n";
push @output, "; put in r1 now since we need it for fog.																								; LINEINFO(BumpmappedLightmap.vsh)(14)\n";
push @output, "dp4 $projPos.x, $vPos, $cModelViewProj0																								; LINEINFO(BumpmappedLightmap.vsh)(15)\n";
push @output, "dp4 $projPos.y, $vPos, $cModelViewProj1																								; LINEINFO(BumpmappedLightmap.vsh)(16)\n";
push @output, "dp4 $projPos.z, $vPos, $cModelViewProj2																								; LINEINFO(BumpmappedLightmap.vsh)(17)\n";
push @output, "dp4 $projPos.w, $vPos, $cModelViewProj3																								; LINEINFO(BumpmappedLightmap.vsh)(18)\n";
push @output, "mov oPos, $projPos																								; LINEINFO(BumpmappedLightmap.vsh)(20)\n";
local( $worldPos ); &AllocateRegister( \$worldPos, "\$worldPos" );
if( $DOWATERFOG == 1 )																								
{																								
	push @output, "	; Get the worldpos z component only since that's all we need for height fog																								; LINEINFO(BumpmappedLightmap.vsh)(25)\n";
	push @output, "	dp4 $worldPos.z, $vPos, $cModel2																								; LINEINFO(BumpmappedLightmap.vsh)(26)\n";
}																								
&CalcFog( $worldPos, $projPos );																								
&FreeRegister( \$worldPos, "\$worldPos" );
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(BumpmappedLightmap.vsh)(32)\n";
push @output, "; Texture coordinates																								; LINEINFO(BumpmappedLightmap.vsh)(33)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(BumpmappedLightmap.vsh)(34)\n";
push @output, "; Compute the texture coordinates given the offset between																								; LINEINFO(BumpmappedLightmap.vsh)(36)\n";
push @output, "; each bumped lightmap																								; LINEINFO(BumpmappedLightmap.vsh)(37)\n";
&AllocateRegister( \$bumpOffset, "\$bumpOffset" );																								
push @output, "mov $bumpOffset.xy, $vTexCoord2																								; LINEINFO(BumpmappedLightmap.vsh)(41)\n";
push @output, "mov oT0, $vTexCoord0				; bumpmap texcoords 																								; LINEINFO(BumpmappedLightmap.vsh)(42)\n";
push @output, "add oT1.xy, $bumpOffset, $vTexCoord1			; first lightmap texcoord																								; LINEINFO(BumpmappedLightmap.vsh)(43)\n";
push @output, "mad oT2.xy, $bumpOffset, $cTwo, $vTexCoord1		; second lightmap texcoord																								; LINEINFO(BumpmappedLightmap.vsh)(44)\n";
push @output, "; make a 3																								; LINEINFO(BumpmappedLightmap.vsh)(45)\n";
local( $three ); &AllocateRegister( \$three, "\$three" );
push @output, "add $three, $cOne, $cTwo																								; LINEINFO(BumpmappedLightmap.vsh)(47)\n";
push @output, "mad oT3.xy, $bumpOffset, $three, $vTexCoord1	; third lightmap texcoord																								; LINEINFO(BumpmappedLightmap.vsh)(48)\n";
&FreeRegister( \$three, "\$three" );
&FreeRegister( \$bumpOffset, "\$bumpOffset" );																								
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(BumpmappedLightmap.vsh)(53)\n";
push @output, "; Fog																								; LINEINFO(BumpmappedLightmap.vsh)(54)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(BumpmappedLightmap.vsh)(55)\n";
&FreeRegister( \$projPos, "\$projPos" );
