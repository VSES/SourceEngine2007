...
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(overlay_fit_vs11.vsh)(5)\n";
push @output, "; Constants specified by the app																								; LINEINFO(overlay_fit_vs11.vsh)(6)\n";
     push @output, ";    c0      = (0, 1, 2, 0.5)																								; LINEINFO(overlay_fit_vs11.vsh)(7)\n";
 	 push @output, ";	 c1		 = (1/2.2, 0, 0, 0)																								; LINEINFO(overlay_fit_vs11.vsh)(8)\n";
     push @output, ";    c2      = camera position *in world space*																								; LINEINFO(overlay_fit_vs11.vsh)(9)\n";
     push @output, ";    c4-c7   = modelViewProj matrix	(transpose)																								; LINEINFO(overlay_fit_vs11.vsh)(10)\n";
     push @output, ";    c8-c11  = ViewProj matrix (transpose)																								; LINEINFO(overlay_fit_vs11.vsh)(11)\n";
     push @output, ";    c12-c15 = model->view matrix (transpose)																								; LINEINFO(overlay_fit_vs11.vsh)(12)\n";
 	 push @output, ";	 c16	 = [fogStart, fogEnd, fogRange, undefined]																								; LINEINFO(overlay_fit_vs11.vsh)(13)\n";
 																								push @output, ";																								; LINEINFO(overlay_fit_vs11.vsh)(14)\n";
push @output, "; Vertex components (as specified in the vertex DECL)																								; LINEINFO(overlay_fit_vs11.vsh)(15)\n";
     push @output, ";    $vPos    = Position																								; LINEINFO(overlay_fit_vs11.vsh)(16)\n";
 	 push @output, ";	 $vTexCoord0.xy = TexCoord0																								; LINEINFO(overlay_fit_vs11.vsh)(17)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(overlay_fit_vs11.vsh)(18)\n";
...
push @output, "; Vertex components																								; LINEINFO(overlay_fit_vs11.vsh)(22)\n";
     push @output, ";    $vPos		= Position																								; LINEINFO(overlay_fit_vs11.vsh)(23)\n";
 	 push @output, ";	 $vNormal		= normal																								; LINEINFO(overlay_fit_vs11.vsh)(24)\n";
 	 push @output, ";	 $vTexCoord0.xy	= TexCoord0																								; LINEINFO(overlay_fit_vs11.vsh)(25)\n";
 	 push @output, ";	 $vTangentS		= S axis of Texture space																								; LINEINFO(overlay_fit_vs11.vsh)(26)\n";
 	 push @output, ";	 $vTangentT	= T axis of Texture space																								; LINEINFO(overlay_fit_vs11.vsh)(27)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(overlay_fit_vs11.vsh)(29)\n";
push @output, "; Transform the position from world to view space																								; LINEINFO(overlay_fit_vs11.vsh)(30)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(overlay_fit_vs11.vsh)(31)\n";
local( $worldPos ); &AllocateRegister( \$worldPos, "\$worldPos" );
local( $projPos ); &AllocateRegister( \$projPos, "\$projPos" );
push @output, "; Transform position from world to projection space																								; LINEINFO(overlay_fit_vs11.vsh)(37)\n";
push @output, "dp4 $projPos.x, $vPos, $cViewProj0																								; LINEINFO(overlay_fit_vs11.vsh)(38)\n";
push @output, "dp4 $projPos.y, $vPos, $cViewProj1																								; LINEINFO(overlay_fit_vs11.vsh)(39)\n";
push @output, "dp4 $projPos.z, $vPos, $cViewProj2																								; LINEINFO(overlay_fit_vs11.vsh)(40)\n";
push @output, "dp4 $projPos.w, $vPos, $cViewProj3																								; LINEINFO(overlay_fit_vs11.vsh)(41)\n";
push @output, "mov oPos, $projPos																								; LINEINFO(overlay_fit_vs11.vsh)(42)\n";
push @output, "dp4 $worldPos.z, $vPos, $cModel2																								; LINEINFO(overlay_fit_vs11.vsh)(44)\n";
&CalcFog( $worldPos, $projPos );																								
&FreeRegister( \$projPos, "\$projPos" );
&FreeRegister( \$worldPos, "\$worldPos" );
push @output, "mov oD0, $vColor																								; LINEINFO(overlay_fit_vs11.vsh)(51)\n";
push @output, "mov oT0, $vTexCoord0																								; LINEINFO(overlay_fit_vs11.vsh)(53)\n";
push @output, "mov oT1, $vTexCoord1																								; LINEINFO(overlay_fit_vs11.vsh)(54)\n";
push @output, "mov oT2, $vTexCoord2																								; LINEINFO(overlay_fit_vs11.vsh)(55)\n";
