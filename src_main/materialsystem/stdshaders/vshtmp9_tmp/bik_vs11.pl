push @output, "vs.1.1																								; LINEINFO(bik_vs11.vsh)(1)\n";
...
&AllocateRegister( \$projPos, "\$projPos" );																								
push @output, "dp4 $projPos.x, $vPos, $cModelViewProj0																								; LINEINFO(bik_vs11.vsh)(7)\n";
push @output, "dp4 $projPos.y, $vPos, $cModelViewProj1																								; LINEINFO(bik_vs11.vsh)(8)\n";
push @output, "dp4 $projPos.z, $vPos, $cModelViewProj2																								; LINEINFO(bik_vs11.vsh)(9)\n";
push @output, "dp4 $projPos.w, $vPos, $cModelViewProj3																								; LINEINFO(bik_vs11.vsh)(10)\n";
push @output, "mov oPos, $projPos																								; LINEINFO(bik_vs11.vsh)(11)\n";
push @output, "mov oT0, $vTexCoord0																								; LINEINFO(bik_vs11.vsh)(13)\n";
push @output, "mov oT1, $vTexCoord0																								; LINEINFO(bik_vs11.vsh)(14)\n";
push @output, "mov oT2, $vTexCoord0																								; LINEINFO(bik_vs11.vsh)(15)\n";
push @output, "mov oT3, $vTexCoord0																								; LINEINFO(bik_vs11.vsh)(16)\n";
&FreeRegister( \$projPos, "\$projPos" );																								
