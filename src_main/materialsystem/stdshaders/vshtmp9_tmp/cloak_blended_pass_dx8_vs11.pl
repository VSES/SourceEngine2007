...
push @output, "vs.1.1																								; LINEINFO(cloak_blended_pass_dx8_vs11.vsh)(3)\n";
...
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(cloak_blended_pass_dx8_vs11.vsh)(6)\n";
push @output, "; Vertex blending 																								; LINEINFO(cloak_blended_pass_dx8_vs11.vsh)(7)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(cloak_blended_pass_dx8_vs11.vsh)(8)\n";
...
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(cloak_blended_pass_dx8_vs11.vsh)(20)\n";
push @output, "; Transform the position from world to view space																								; LINEINFO(cloak_blended_pass_dx8_vs11.vsh)(21)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(cloak_blended_pass_dx8_vs11.vsh)(22)\n";
push @output, "dp4 $projPos.x, $worldPos, $cViewProj0																								; LINEINFO(cloak_blended_pass_dx8_vs11.vsh)(23)\n";
push @output, "dp4 $projPos.y, $worldPos, $cViewProj1																								; LINEINFO(cloak_blended_pass_dx8_vs11.vsh)(24)\n";
push @output, "dp4 $projPos.z, $worldPos, $cViewProj2																								; LINEINFO(cloak_blended_pass_dx8_vs11.vsh)(25)\n";
push @output, "dp4 $projPos.w, $worldPos, $cViewProj3																								; LINEINFO(cloak_blended_pass_dx8_vs11.vsh)(26)\n";
push @output, "mov oPos, $projPos																								; LINEINFO(cloak_blended_pass_dx8_vs11.vsh)(28)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(cloak_blended_pass_dx8_vs11.vsh)(30)\n";
push @output, "; Fog - don't bother with water fog for intro effects																								; LINEINFO(cloak_blended_pass_dx8_vs11.vsh)(31)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(cloak_blended_pass_dx8_vs11.vsh)(32)\n";
&DepthFog( $projPos, "oFog" );																								
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(cloak_blended_pass_dx8_vs11.vsh)(35)\n";
push @output, "; Refract uv's (Code copied from predator.vsh)																								; LINEINFO(cloak_blended_pass_dx8_vs11.vsh)(36)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(cloak_blended_pass_dx8_vs11.vsh)(37)\n";
push @output, "; NOTE: projPos isn't projPos after this point. :)																								; LINEINFO(cloak_blended_pass_dx8_vs11.vsh)(38)\n";
&AllocateRegister( \$projNormal, "\$projNormal" );																								
push @output, "; only do X and Y since that's all we care about																								; LINEINFO(cloak_blended_pass_dx8_vs11.vsh)(42)\n";
push @output, "dp3 $projNormal.x, $worldNormal, $cViewProj0																								; LINEINFO(cloak_blended_pass_dx8_vs11.vsh)(43)\n";
push @output, "dp3 $projNormal.y, $worldNormal, $cViewProj1																								; LINEINFO(cloak_blended_pass_dx8_vs11.vsh)(44)\n";
push @output, "; divide by z																								; LINEINFO(cloak_blended_pass_dx8_vs11.vsh)(46)\n";
push @output, "rcp $projPos.w, $projPos.w																								; LINEINFO(cloak_blended_pass_dx8_vs11.vsh)(47)\n";
push @output, "mul $projPos.xy, $projPos.w, $projPos.xy																								; LINEINFO(cloak_blended_pass_dx8_vs11.vsh)(48)\n";
push @output, "; map from -1..1 to 0..1																								; LINEINFO(cloak_blended_pass_dx8_vs11.vsh)(50)\n";
push @output, "mad $projPos.xy, $projPos.xy, $cHalf, $cHalf																								; LINEINFO(cloak_blended_pass_dx8_vs11.vsh)(51)\n";
push @output, "; tweak with the texcoords based on the normal and $refractionamount																								; LINEINFO(cloak_blended_pass_dx8_vs11.vsh)(53)\n";
push @output, "mad $projPos.xy, $projNormal.xy, -$SHADER_SPECIFIC_CONST_4.xy, $projPos.xy		; FIXME																								; LINEINFO(cloak_blended_pass_dx8_vs11.vsh)(54)\n";
push @output, "; invert y																								; LINEINFO(cloak_blended_pass_dx8_vs11.vsh)(56)\n";
push @output, "add $projPos.y, $cOne, -$projPos.y																								; LINEINFO(cloak_blended_pass_dx8_vs11.vsh)(57)\n";
push @output, "; hack scale for nvidia (Power of two texcoords are screwed.)																								; LINEINFO(cloak_blended_pass_dx8_vs11.vsh)(59)\n";
push @output, "mul oT0.xy, $projPos.xy, $SHADER_SPECIFIC_CONST_5.xy																								; LINEINFO(cloak_blended_pass_dx8_vs11.vsh)(60)\n";
push @output, "; YUCK!  This is to make texcoords continuous for mat_softwaretl																								; LINEINFO(cloak_blended_pass_dx8_vs11.vsh)(62)\n";
push @output, "mov oT2, $cZero																								; LINEINFO(cloak_blended_pass_dx8_vs11.vsh)(63)\n";
&FreeRegister( \$projPos, "\$projPos" );																								
&FreeRegister( \$projNormal, "\$projNormal" );																								
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(cloak_blended_pass_dx8_vs11.vsh)(68)\n";
push @output, "; Refract mask																								; LINEINFO(cloak_blended_pass_dx8_vs11.vsh)(69)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(cloak_blended_pass_dx8_vs11.vsh)(70)\n";
push @output, "; // float flFresnel = 1.0f - saturate( dot( i.vWorldNormal.xyz, normalize( -i.vWorldViewVector.xyz ) ) );																								; LINEINFO(cloak_blended_pass_dx8_vs11.vsh)(72)\n";
&AllocateRegister( \$flFresnel, "\$flFresnel" );																								
&AllocateRegister( \$tmp1, "\$tmp1" );																								
push @output, "sub $flFresnel, $worldPos, $cEyePos																								; LINEINFO(cloak_blended_pass_dx8_vs11.vsh)(76)\n";
&Normalize( $flFresnel );																								
push @output, "dp3 $flFresnel, -$flFresnel, $worldNormal																								; LINEINFO(cloak_blended_pass_dx8_vs11.vsh)(78)\n";
push @output, "max $flFresnel, $flFresnel, $cZero																								; LINEINFO(cloak_blended_pass_dx8_vs11.vsh)(79)\n";
push @output, "sub $flFresnel, $cOne, $flFresnel																								; LINEINFO(cloak_blended_pass_dx8_vs11.vsh)(80)\n";
push @output, "; // float flCloakLerpFactor = saturate( lerp( 1.0f, flFresnel - 1.35f, saturate( g_flCloakFactor ) ) );																								; LINEINFO(cloak_blended_pass_dx8_vs11.vsh)(82)\n";
&AllocateRegister( \$flCloakLerpFactor, "\$flCloakLerpFactor" );																								
push @output, "sub $flCloakLerpFactor, $flFresnel, $SHADER_SPECIFIC_CONST_3.x ; // flFresnel - 1.35f																								; LINEINFO(cloak_blended_pass_dx8_vs11.vsh)(85)\n";
push @output, "mov $tmp1, $cOne																								; LINEINFO(cloak_blended_pass_dx8_vs11.vsh)(86)\n";
push @output, "sub $flCloakLerpFactor, $flCloakLerpFactor, $tmp1																								; LINEINFO(cloak_blended_pass_dx8_vs11.vsh)(87)\n";
push @output, "mad $flCloakLerpFactor, $flCloakLerpFactor, $SHADER_SPECIFIC_CONST_3.y, $tmp1																								; LINEINFO(cloak_blended_pass_dx8_vs11.vsh)(88)\n";
push @output, "max $flCloakLerpFactor, $flCloakLerpFactor, $cZero																								; LINEINFO(cloak_blended_pass_dx8_vs11.vsh)(89)\n";
push @output, "min $flCloakLerpFactor, $flCloakLerpFactor, $cOne																								; LINEINFO(cloak_blended_pass_dx8_vs11.vsh)(90)\n";
push @output, "; // flCloakLerpFactor = 1.0f - smoothstep( 0.4f, 0.425f, flCloakLerpFactor );																								; LINEINFO(cloak_blended_pass_dx8_vs11.vsh)(92)\n";
push @output, "sub $flCloakLerpFactor, $flCloakLerpFactor, $SHADER_SPECIFIC_CONST_3.z																								; LINEINFO(cloak_blended_pass_dx8_vs11.vsh)(93)\n";
push @output, "mul $flCloakLerpFactor, $flCloakLerpFactor, $SHADER_SPECIFIC_CONST_3.w																								; LINEINFO(cloak_blended_pass_dx8_vs11.vsh)(94)\n";
push @output, "sub $flCloakLerpFactor, $cOne, $flCloakLerpFactor																								; LINEINFO(cloak_blended_pass_dx8_vs11.vsh)(95)\n";
push @output, "mov oD0, $flCloakLerpFactor																								; LINEINFO(cloak_blended_pass_dx8_vs11.vsh)(97)\n";
&FreeRegister( \$tmp1, "\$tmp1" );																								
&FreeRegister( \$flFresnel, "\$flFresnel" );																								
&FreeRegister( \$flCloakLerpFactor, "\$flCloakLerpFactor" );																								
