...
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(Eyes.vsh)(2)\n";
 	 push @output, ";	 $SHADER_SPECIFIC_CONST_0	 = eyeball origin																											; LINEINFO(Eyes.vsh)(3)\n";
 	 push @output, ";	 $SHADER_SPECIFIC_CONST_1	 = eyeball up * 0.5																											; LINEINFO(Eyes.vsh)(4)\n";
 	 push @output, ";	 $SHADER_SPECIFIC_CONST_2	 = iris projection U																										; LINEINFO(Eyes.vsh)(5)\n";
 	 push @output, ";	 $SHADER_SPECIFIC_CONST_3	 = iris projection V																										; LINEINFO(Eyes.vsh)(6)\n";
 	 push @output, ";	 $SHADER_SPECIFIC_CONST_4	 = glint projection U																										; LINEINFO(Eyes.vsh)(7)\n";
 	 push @output, ";	 $SHADER_SPECIFIC_CONST_5	 = glint projection V																										; LINEINFO(Eyes.vsh)(8)\n";
...
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(Eyes.vsh)(18)\n";
push @output, "; Vertex blending (whacks r1-r7, positions in r7)																								; LINEINFO(Eyes.vsh)(19)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(Eyes.vsh)(20)\n";
&AllocateRegister( \$worldPos, "\$worldPos" );																								
&SkinPosition( $worldPos );																								
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(Eyes.vsh)(24)\n";
push @output, "; Transform the position from world to view space																								; LINEINFO(Eyes.vsh)(25)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(Eyes.vsh)(26)\n";
&AllocateRegister( \$projPos, "\$projPos" );																								
push @output, "dp4 $projPos.x, $worldPos, $cViewProj0																								; LINEINFO(Eyes.vsh)(30)\n";
push @output, "dp4 $projPos.y, $worldPos, $cViewProj1																								; LINEINFO(Eyes.vsh)(31)\n";
push @output, "dp4 $projPos.z, $worldPos, $cViewProj2																								; LINEINFO(Eyes.vsh)(32)\n";
push @output, "dp4 $projPos.w, $worldPos, $cViewProj3																								; LINEINFO(Eyes.vsh)(33)\n";
push @output, "mov oPos, $projPos																								; LINEINFO(Eyes.vsh)(34)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(Eyes.vsh)(36)\n";
push @output, "; Normal is based on vertex position 																								; LINEINFO(Eyes.vsh)(37)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(Eyes.vsh)(38)\n";
&AllocateRegister( \$worldNormal, "\$worldNormal" );																								
&AllocateRegister( \$normalDotUp, "\$normalDotUp" );																								
push @output, "sub $worldNormal, $worldPos, $SHADER_SPECIFIC_CONST_0		; Normal = (Pos - Eye origin)																								; LINEINFO(Eyes.vsh)(42)\n";
push @output, "dp3 $normalDotUp, $worldNormal, $SHADER_SPECIFIC_CONST_1		; Normal -= 0.5f * (Normal dot Eye Up) * Eye Up																								; LINEINFO(Eyes.vsh)(43)\n";
push @output, "mul $normalDotUp, $normalDotUp, $cHalf																								; LINEINFO(Eyes.vsh)(44)\n";
push @output, "mad $worldNormal, -$normalDotUp, $SHADER_SPECIFIC_CONST_1, $worldNormal																								; LINEINFO(Eyes.vsh)(45)\n";
&FreeRegister( \$normalDotUp, "\$normalDotUp" );																								
push @output, "; normalize the normal																								; LINEINFO(Eyes.vsh)(49)\n";
&Normalize( $worldNormal );																								
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(Eyes.vsh)(52)\n";
push @output, "; Lighting																								; LINEINFO(Eyes.vsh)(53)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(Eyes.vsh)(54)\n";
&DoLighting( $worldPos, $worldNormal );																								
&FreeRegister( \$worldNormal, "\$worldNormal" );																								
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(Eyes.vsh)(59)\n";
push @output, "; Fog																								; LINEINFO(Eyes.vsh)(60)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(Eyes.vsh)(61)\n";
&CalcFog( $worldPos, $projPos );																								
&FreeRegister( \$projPos, "\$projPos" );																								
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(Eyes.vsh)(67)\n";
push @output, "; Texture coordinates																								; LINEINFO(Eyes.vsh)(68)\n";
push @output, "; Texture 0 is the base texture																								; LINEINFO(Eyes.vsh)(69)\n";
push @output, "; Texture 1 is a planar projection used for the iris																								; LINEINFO(Eyes.vsh)(70)\n";
push @output, "; Texture 2 is a planar projection used for the glint																								; LINEINFO(Eyes.vsh)(71)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(Eyes.vsh)(72)\n";
push @output, "mov oT0, $vTexCoord0																								; LINEINFO(Eyes.vsh)(74)\n";
push @output, "dp4 oT1.x, $SHADER_SPECIFIC_CONST_2, $worldPos																								; LINEINFO(Eyes.vsh)(75)\n";
push @output, "dp4 oT1.y, $SHADER_SPECIFIC_CONST_3, $worldPos																								; LINEINFO(Eyes.vsh)(76)\n";
push @output, "dp4 oT2.x, $SHADER_SPECIFIC_CONST_4, $worldPos																								; LINEINFO(Eyes.vsh)(77)\n";
push @output, "dp4 oT2.y, $SHADER_SPECIFIC_CONST_5, $worldPos																								; LINEINFO(Eyes.vsh)(78)\n";
