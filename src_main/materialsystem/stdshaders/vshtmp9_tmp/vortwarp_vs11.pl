...
push @output, "vs.1.1																								; LINEINFO(vortwarp_vs11.vsh)(6)\n";
...
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(vortwarp_vs11.vsh)(12)\n";
push @output, "; Vertex blending 																								; LINEINFO(vortwarp_vs11.vsh)(13)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(vortwarp_vs11.vsh)(14)\n";
&AllocateRegister( \$worldPos, "\$worldPos" );																								
&AllocateRegister( \$worldNormal, "\$worldNormal" );																								
&AllocateRegister( \$projPos, "\$projPos" );																								
&SkinPositionAndNormal( $worldPos, $worldNormal );																								
local( $tmp ); &AllocateRegister( \$tmp, "\$tmp" );
push @output, "sub $tmp.xyz, $worldPos, $ENTITY_ORIGIN																								; LINEINFO(vortwarp_vs11.vsh)(22)\n";
push @output, "mul $tmp.xy, $tmp, $WARPPARAM																								; LINEINFO(vortwarp_vs11.vsh)(23)\n";
push @output, "add $worldPos.xyz, $tmp, $ENTITY_ORIGIN																								; LINEINFO(vortwarp_vs11.vsh)(24)\n";
&FreeRegister( \$tmp, "\$tmp" );
if( $SKINNING == 1 )																								
{																								
	&Normalize( $worldNormal );																								
}																								
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(vortwarp_vs11.vsh)(32)\n";
push @output, "; Transform the position from world to view space																								; LINEINFO(vortwarp_vs11.vsh)(33)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(vortwarp_vs11.vsh)(34)\n";
push @output, "dp4 $projPos.x, $worldPos, $cViewProj0																								; LINEINFO(vortwarp_vs11.vsh)(35)\n";
push @output, "dp4 $projPos.y, $worldPos, $cViewProj1																								; LINEINFO(vortwarp_vs11.vsh)(36)\n";
push @output, "dp4 $projPos.z, $worldPos, $cViewProj2																								; LINEINFO(vortwarp_vs11.vsh)(37)\n";
push @output, "dp4 $projPos.w, $worldPos, $cViewProj3																								; LINEINFO(vortwarp_vs11.vsh)(38)\n";
push @output, "mov oPos, $projPos																								; LINEINFO(vortwarp_vs11.vsh)(40)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(vortwarp_vs11.vsh)(42)\n";
push @output, "; Fog - don't bother with water fog for intro effects																								; LINEINFO(vortwarp_vs11.vsh)(43)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(vortwarp_vs11.vsh)(44)\n";
&DepthFog( $projPos, "oFog" );																								
&FreeRegister( \$projPos, "\$projPos" );																								
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(vortwarp_vs11.vsh)(48)\n";
push @output, "; Lighting																								; LINEINFO(vortwarp_vs11.vsh)(49)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(vortwarp_vs11.vsh)(50)\n";
if( $UNLIT )																								
{																								
	push @output, "	mov oD0, $cHalf																								; LINEINFO(vortwarp_vs11.vsh)(53)\n";
}																								
else																								
{																								
...
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(vortwarp_vs11.vsh)(65)\n";
push @output, "; Texture coordinates																								; LINEINFO(vortwarp_vs11.vsh)(66)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(vortwarp_vs11.vsh)(67)\n";
push @output, "dp4 oT0.x, $vTexCoord0, $SHADER_SPECIFIC_CONST_0																								; LINEINFO(vortwarp_vs11.vsh)(69)\n";
push @output, "dp4 oT0.y, $vTexCoord0, $SHADER_SPECIFIC_CONST_1																								; LINEINFO(vortwarp_vs11.vsh)(70)\n";
local( $tmp2 ); &AllocateRegister( \$tmp2, "\$tmp2" );
push @output, "dp4 $tmp2.x, $vTexCoord0, $SHADER_SPECIFIC_CONST_0																								; LINEINFO(vortwarp_vs11.vsh)(74)\n";
push @output, "dp4 $tmp2.y, $vTexCoord0, $SHADER_SPECIFIC_CONST_1																								; LINEINFO(vortwarp_vs11.vsh)(75)\n";
push @output, "add oT1.xy, $tmp2, $SHADER_SPECIFIC_CONST_4																								; LINEINFO(vortwarp_vs11.vsh)(77)\n";
&FreeRegister( \$tmp2, "\$tmp2" );
push @output, "; YUCK!  This is to make texcoords continuous for mat_softwaretl																								; LINEINFO(vortwarp_vs11.vsh)(81)\n";
push @output, "mov oT2, $cZero																								; LINEINFO(vortwarp_vs11.vsh)(82)\n";
