push @output, "vs.1.1																								; LINEINFO(VertexLitGeneric_vs11.vsh)(1)\n";
...
{																								
	...
	push @output, "	;------------------------------------------------------------------------------																								; LINEINFO(VertexLitGeneric_inc.vsh)(14)\n";
	push @output, "	; Vertex blending 																								; LINEINFO(VertexLitGeneric_inc.vsh)(15)\n";
	push @output, "	;------------------------------------------------------------------------------																								; LINEINFO(VertexLitGeneric_inc.vsh)(16)\n";
	&AllocateRegister( \$worldPos, "\$worldPos" );																								
	&AllocateRegister( \$worldNormal, "\$worldNormal" );																								
	&AllocateRegister( \$projPos, "\$projPos" );																								
 	push @output, ";	if( $g_staticLightType eq \"static\" && $g_ambientLightType eq \"none\" &&																								; LINEINFO(VertexLitGeneric_inc.vsh)(20)\n";
 		push @output, ";		$g_localLightType1 eq \"none\" && $g_localLightType2 eq \"none\" && !$envmap )																								; LINEINFO(VertexLitGeneric_inc.vsh)(21)\n";
	if( 0 )																								
	{																								
		push @output, "		; NOTE: Don't do this optimization anymore since it would mean a gazillion combos																								; LINEINFO(VertexLitGeneric_inc.vsh)(24)\n";
		push @output, "		; of the flashlight shaders																								; LINEINFO(VertexLitGeneric_inc.vsh)(25)\n";
		push @output, "		; Special case for static prop lighting.  We can go directly from 																								; LINEINFO(VertexLitGeneric_inc.vsh)(26)\n";
		push @output, "		; world to proj space for position, with the exception of z, which 																								; LINEINFO(VertexLitGeneric_inc.vsh)(27)\n";
		push @output, "		; is needed for fogging *if* height fog is enabled.																								; LINEINFO(VertexLitGeneric_inc.vsh)(28)\n";
		push @output, "		; NOTE: We don't use this path if $envmap is defined since we need																								; LINEINFO(VertexLitGeneric_inc.vsh)(30)\n";
		push @output, "		; worldpos for envmapping.																								; LINEINFO(VertexLitGeneric_inc.vsh)(31)\n";
		push @output, "		dp4 $projPos.x, $vPos, $cModelViewProj0																								; LINEINFO(VertexLitGeneric_inc.vsh)(32)\n";
		push @output, "		dp4 $projPos.y, $vPos, $cModelViewProj1																								; LINEINFO(VertexLitGeneric_inc.vsh)(33)\n";
		push @output, "		dp4 $projPos.z, $vPos, $cModelViewProj2																								; LINEINFO(VertexLitGeneric_inc.vsh)(34)\n";
		push @output, "		dp4 $projPos.w, $vPos, $cModelViewProj3																								; LINEINFO(VertexLitGeneric_inc.vsh)(35)\n";
		push @output, "		; normal																								; LINEINFO(VertexLitGeneric_inc.vsh)(36)\n";
		push @output, "		dp3 $worldNormal.x, $vNormal, $cModel0																								; LINEINFO(VertexLitGeneric_inc.vsh)(37)\n";
		push @output, "		dp3 $worldNormal.y, $vNormal, $cModel1																								; LINEINFO(VertexLitGeneric_inc.vsh)(38)\n";
		push @output, "		dp3 $worldNormal.z, $vNormal, $cModel2																								; LINEINFO(VertexLitGeneric_inc.vsh)(39)\n";
		push @output, "		; Need this for height fog if it's enabled and for height clipping																								; LINEINFO(VertexLitGeneric_inc.vsh)(41)\n";
		push @output, "		dp4 $worldPos.z, $vPos, $cModel2																								; LINEINFO(VertexLitGeneric_inc.vsh)(42)\n";
	}																								
	else																								
	{																								
		...
		push @output, "		;------------------------------------------------------------------------------																								; LINEINFO(VertexLitGeneric_inc.vsh)(53)\n";
		push @output, "		; Transform the position from world to view space																								; LINEINFO(VertexLitGeneric_inc.vsh)(54)\n";
		push @output, "		;------------------------------------------------------------------------------																								; LINEINFO(VertexLitGeneric_inc.vsh)(55)\n";
		push @output, "		dp4 $projPos.x, $worldPos, $cViewProj0																								; LINEINFO(VertexLitGeneric_inc.vsh)(56)\n";
		push @output, "		dp4 $projPos.y, $worldPos, $cViewProj1																								; LINEINFO(VertexLitGeneric_inc.vsh)(57)\n";
		push @output, "		dp4 $projPos.z, $worldPos, $cViewProj2																								; LINEINFO(VertexLitGeneric_inc.vsh)(58)\n";
		push @output, "		dp4 $projPos.w, $worldPos, $cViewProj3																								; LINEINFO(VertexLitGeneric_inc.vsh)(59)\n";
	}																								
	push @output, "	mov oPos, $projPos																								; LINEINFO(VertexLitGeneric_inc.vsh)(62)\n";
	push @output, "	;------------------------------------------------------------------------------																								; LINEINFO(VertexLitGeneric_inc.vsh)(64)\n";
	push @output, "	; Fog																								; LINEINFO(VertexLitGeneric_inc.vsh)(65)\n";
	push @output, "	;------------------------------------------------------------------------------																								; LINEINFO(VertexLitGeneric_inc.vsh)(66)\n";
	&CalcFog( $worldPos, $projPos );																								
	&FreeRegister( \$projPos, "\$projPos" );																								
	push @output, "	;------------------------------------------------------------------------------																								; LINEINFO(VertexLitGeneric_inc.vsh)(70)\n";
	push @output, "	; Lighting																								; LINEINFO(VertexLitGeneric_inc.vsh)(71)\n";
	...
	push @output, "	;------------------------------------------------------------------------------																								; LINEINFO(VertexLitGeneric_inc.vsh)(80)\n";
	push @output, "	; Texture coordinates																								; LINEINFO(VertexLitGeneric_inc.vsh)(81)\n";
	push @output, "	;------------------------------------------------------------------------------																								; LINEINFO(VertexLitGeneric_inc.vsh)(82)\n";
	push @output, "	dp4 oT0.x, $vTexCoord0, $SHADER_SPECIFIC_CONST_0																								; LINEINFO(VertexLitGeneric_inc.vsh)(84)\n";
	push @output, "	dp4 oT0.y, $vTexCoord0, $SHADER_SPECIFIC_CONST_1																								; LINEINFO(VertexLitGeneric_inc.vsh)(85)\n";
	if( $envmap )																								
	{																								
		...
		{																								
			...
			push @output, "			; transform reflection vector into view space																								; LINEINFO(VertexLitGeneric_inc.vsh)(94)\n";
			push @output, "			dp3 oT1.x, $reflectionVector, $cViewModel0																								; LINEINFO(VertexLitGeneric_inc.vsh)(95)\n";
			push @output, "			dp3 oT1.y, $reflectionVector, $cViewModel1																								; LINEINFO(VertexLitGeneric_inc.vsh)(96)\n";
			push @output, "			dp3 oT1.z, $reflectionVector, $cViewModel2																								; LINEINFO(VertexLitGeneric_inc.vsh)(97)\n";
		...
		push @output, "		; envmap mask																								; LINEINFO(VertexLitGeneric_inc.vsh)(114)\n";
		push @output, "		dp4 oT2.x, $vTexCoord0, $SHADER_SPECIFIC_CONST_2																								; LINEINFO(VertexLitGeneric_inc.vsh)(115)\n";
		push @output, "		dp4 oT2.y, $vTexCoord0, $SHADER_SPECIFIC_CONST_3																								; LINEINFO(VertexLitGeneric_inc.vsh)(116)\n";
		&FreeRegister( \$worldNormal, "\$worldNormal" );																								
	}																								
	else																								
	{																								
		...
		{																								
			...
			push @output, "			mov $temp, $vTexCoord0																								; LINEINFO(VertexLitGeneric_inc.vsh)(125)\n";
			push @output, "			sub oT1.xyz, $temp.xyz, $vTexCoord1.xyz																								; LINEINFO(VertexLitGeneric_inc.vsh)(126)\n";
			push @output, "			sub oT2.xyz, $vTexCoord2.xyz, $temp.xyz																								; LINEINFO(VertexLitGeneric_inc.vsh)(127)\n";
			&FreeRegister( \$temp, "\$temp" );																								
		}																								
		else																								
		{																								
			push @output, "			; YUCK!  This is to make texcoords continuous for mat_softwaretl																								; LINEINFO(VertexLitGeneric_inc.vsh)(132)\n";
			push @output, "			mov oT1, $cZero																								; LINEINFO(VertexLitGeneric_inc.vsh)(133)\n";
			push @output, "			mov oT2, $cZero																								; LINEINFO(VertexLitGeneric_inc.vsh)(134)\n";
		}																								
	}																								
	if( $detail )																								
	{																								
		push @output, "		dp4 oT3.x, $vTexCoord0, $SHADER_SPECIFIC_CONST_4																								; LINEINFO(VertexLitGeneric_inc.vsh)(140)\n";
		push @output, "		dp4 oT3.y, $vTexCoord0, $SHADER_SPECIFIC_CONST_5																								; LINEINFO(VertexLitGeneric_inc.vsh)(141)\n";
	}																								
