...
push @output, "vs.1.1																								; LINEINFO(emissive_scroll_blended_pass_dx8_vs11.vsh)(3)\n";
...
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(emissive_scroll_blended_pass_dx8_vs11.vsh)(6)\n";
push @output, "; Vertex blending 																								; LINEINFO(emissive_scroll_blended_pass_dx8_vs11.vsh)(7)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(emissive_scroll_blended_pass_dx8_vs11.vsh)(8)\n";
...
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(emissive_scroll_blended_pass_dx8_vs11.vsh)(20)\n";
push @output, "; Transform the position from world to view space																								; LINEINFO(emissive_scroll_blended_pass_dx8_vs11.vsh)(21)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(emissive_scroll_blended_pass_dx8_vs11.vsh)(22)\n";
push @output, "dp4 $projPos.x, $worldPos, $cViewProj0																								; LINEINFO(emissive_scroll_blended_pass_dx8_vs11.vsh)(23)\n";
push @output, "dp4 $projPos.y, $worldPos, $cViewProj1																								; LINEINFO(emissive_scroll_blended_pass_dx8_vs11.vsh)(24)\n";
push @output, "dp4 $projPos.z, $worldPos, $cViewProj2																								; LINEINFO(emissive_scroll_blended_pass_dx8_vs11.vsh)(25)\n";
push @output, "dp4 $projPos.w, $worldPos, $cViewProj3																								; LINEINFO(emissive_scroll_blended_pass_dx8_vs11.vsh)(26)\n";
push @output, "mov oPos, $projPos																								; LINEINFO(emissive_scroll_blended_pass_dx8_vs11.vsh)(28)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(emissive_scroll_blended_pass_dx8_vs11.vsh)(30)\n";
push @output, "; Fog - don't bother with water fog for intro effects																								; LINEINFO(emissive_scroll_blended_pass_dx8_vs11.vsh)(31)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(emissive_scroll_blended_pass_dx8_vs11.vsh)(32)\n";
&DepthFog( $projPos, "oFog" );																								
&FreeRegister( \$projPos, "\$projPos" );																								
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(emissive_scroll_blended_pass_dx8_vs11.vsh)(36)\n";
push @output, "; Lighting																								; LINEINFO(emissive_scroll_blended_pass_dx8_vs11.vsh)(37)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(emissive_scroll_blended_pass_dx8_vs11.vsh)(38)\n";
push @output, "mov oD0, $cHalf																								; LINEINFO(emissive_scroll_blended_pass_dx8_vs11.vsh)(39)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(emissive_scroll_blended_pass_dx8_vs11.vsh)(41)\n";
push @output, "; Texture coordinates																								; LINEINFO(emissive_scroll_blended_pass_dx8_vs11.vsh)(42)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(emissive_scroll_blended_pass_dx8_vs11.vsh)(43)\n";
push @output, "dp4 oT0.x, $vTexCoord0, $SHADER_SPECIFIC_CONST_0																								; LINEINFO(emissive_scroll_blended_pass_dx8_vs11.vsh)(45)\n";
push @output, "dp4 oT0.y, $vTexCoord0, $SHADER_SPECIFIC_CONST_1																								; LINEINFO(emissive_scroll_blended_pass_dx8_vs11.vsh)(46)\n";
local( $tmp2 ); &AllocateRegister( \$tmp2, "\$tmp2" );
push @output, "dp4 $tmp2.x, $vTexCoord0, $SHADER_SPECIFIC_CONST_0																								; LINEINFO(emissive_scroll_blended_pass_dx8_vs11.vsh)(50)\n";
push @output, "dp4 $tmp2.y, $vTexCoord0, $SHADER_SPECIFIC_CONST_1																								; LINEINFO(emissive_scroll_blended_pass_dx8_vs11.vsh)(51)\n";
push @output, "add oT1.xy, $tmp2, $SHADER_SPECIFIC_CONST_4																								; LINEINFO(emissive_scroll_blended_pass_dx8_vs11.vsh)(53)\n";
&FreeRegister( \$tmp2, "\$tmp2" );
push @output, "; YUCK!  This is to make texcoords continuous for mat_softwaretl																								; LINEINFO(emissive_scroll_blended_pass_dx8_vs11.vsh)(57)\n";
push @output, "mov oT2, $cZero																								; LINEINFO(emissive_scroll_blended_pass_dx8_vs11.vsh)(58)\n";
