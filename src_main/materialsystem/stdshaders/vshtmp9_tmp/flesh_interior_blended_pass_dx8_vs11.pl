...
push @output, "vs.1.1																								; LINEINFO(flesh_interior_blended_pass_dx8_vs11.vsh)(3)\n";
...
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(flesh_interior_blended_pass_dx8_vs11.vsh)(6)\n";
push @output, "; Vertex blending 																								; LINEINFO(flesh_interior_blended_pass_dx8_vs11.vsh)(7)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(flesh_interior_blended_pass_dx8_vs11.vsh)(8)\n";
...
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(flesh_interior_blended_pass_dx8_vs11.vsh)(20)\n";
push @output, "; Transform the position from world to view space																								; LINEINFO(flesh_interior_blended_pass_dx8_vs11.vsh)(21)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(flesh_interior_blended_pass_dx8_vs11.vsh)(22)\n";
push @output, "dp4 $projPos.x, $worldPos, $cViewProj0																								; LINEINFO(flesh_interior_blended_pass_dx8_vs11.vsh)(23)\n";
push @output, "dp4 $projPos.y, $worldPos, $cViewProj1																								; LINEINFO(flesh_interior_blended_pass_dx8_vs11.vsh)(24)\n";
push @output, "dp4 $projPos.z, $worldPos, $cViewProj2																								; LINEINFO(flesh_interior_blended_pass_dx8_vs11.vsh)(25)\n";
push @output, "dp4 $projPos.w, $worldPos, $cViewProj3																								; LINEINFO(flesh_interior_blended_pass_dx8_vs11.vsh)(26)\n";
push @output, "mov oPos, $projPos																								; LINEINFO(flesh_interior_blended_pass_dx8_vs11.vsh)(28)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(flesh_interior_blended_pass_dx8_vs11.vsh)(30)\n";
push @output, "; Fog - don't bother with water fog for intro effects																								; LINEINFO(flesh_interior_blended_pass_dx8_vs11.vsh)(31)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(flesh_interior_blended_pass_dx8_vs11.vsh)(32)\n";
&DepthFog( $projPos, "oFog" );																								
&FreeRegister( \$projPos, "\$projPos" );																								
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(flesh_interior_blended_pass_dx8_vs11.vsh)(36)\n";
push @output, "; Flesh area																								; LINEINFO(flesh_interior_blended_pass_dx8_vs11.vsh)(37)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(flesh_interior_blended_pass_dx8_vs11.vsh)(38)\n";
 	push @output, ";	// Store the closest effect intensity																								; LINEINFO(flesh_interior_blended_pass_dx8_vs11.vsh)(39)\n";
 	push @output, ";	o.flDistanceToEffectCenter_flFresnelEffect.x = 9999.0f; // A very large distance																								; LINEINFO(flesh_interior_blended_pass_dx8_vs11.vsh)(40)\n";
 	push @output, ";	o.flDistanceToEffectCenter_flFresnelEffect.x = min( o.flDistanceToEffectCenter_flFresnelEffect.x, length( vWorldPosition.xyz - g_vEffectCenterOoRadius1.xyz ) * g_vEffectCenterOoRadius1.w );																								; LINEINFO(flesh_interior_blended_pass_dx8_vs11.vsh)(41)\n";
 	push @output, ";	o.flDistanceToEffectCenter_flFresnelEffect.x = min( o.flDistanceToEffectCenter_flFresnelEffect.x, length( vWorldPosition.xyz - g_vEffectCenterOoRadius2.xyz ) * g_vEffectCenterOoRadius2.w );																								; LINEINFO(flesh_interior_blended_pass_dx8_vs11.vsh)(42)\n";
 	push @output, ";	o.flDistanceToEffectCenter_flFresnelEffect.x = min( o.flDistanceToEffectCenter_flFresnelEffect.x, length( vWorldPosition.xyz - g_vEffectCenterOoRadius3.xyz ) * g_vEffectCenterOoRadius3.w );																								; LINEINFO(flesh_interior_blended_pass_dx8_vs11.vsh)(43)\n";
 	push @output, ";	o.flDistanceToEffectCenter_flFresnelEffect.x = min( o.flDistanceToEffectCenter_flFresnelEffect.x, length( vWorldPosition.xyz - g_vEffectCenterOoRadius4.xyz ) * g_vEffectCenterOoRadius4.w );																								; LINEINFO(flesh_interior_blended_pass_dx8_vs11.vsh)(44)\n";
local( $tmp1 ); &AllocateRegister( \$tmp1, "\$tmp1" );
local( $flEffect ); &AllocateRegister( \$flEffect, "\$flEffect" );
push @output, "mov $flEffect, $cTwo																								; LINEINFO(flesh_interior_blended_pass_dx8_vs11.vsh)(49)\n";
push @output, "mad $flEffect, $flEffect, $cTwo, $cTwo																								; LINEINFO(flesh_interior_blended_pass_dx8_vs11.vsh)(50)\n";
push @output, "sub $tmp1.xyz, $worldPos, $SHADER_SPECIFIC_CONST_1																								; LINEINFO(flesh_interior_blended_pass_dx8_vs11.vsh)(52)\n";
push @output, "dp3 $tmp1.w, $tmp1, $tmp1																								; LINEINFO(flesh_interior_blended_pass_dx8_vs11.vsh)(53)\n";
push @output, "rsq $tmp1.w, $tmp1.w																								; LINEINFO(flesh_interior_blended_pass_dx8_vs11.vsh)(54)\n";
push @output, "rcp $tmp1.w, $tmp1.w																								; LINEINFO(flesh_interior_blended_pass_dx8_vs11.vsh)(55)\n";
push @output, "mul $tmp1.w, $tmp1.w, $SHADER_SPECIFIC_CONST_1.w																								; LINEINFO(flesh_interior_blended_pass_dx8_vs11.vsh)(56)\n";
push @output, "min $flEffect, $flEffect, $tmp1.w																								; LINEINFO(flesh_interior_blended_pass_dx8_vs11.vsh)(57)\n";
push @output, "sub $tmp1.xyz, $worldPos, $SHADER_SPECIFIC_CONST_2																								; LINEINFO(flesh_interior_blended_pass_dx8_vs11.vsh)(59)\n";
push @output, "dp3 $tmp1.w, $tmp1, $tmp1																								; LINEINFO(flesh_interior_blended_pass_dx8_vs11.vsh)(60)\n";
push @output, "rsq $tmp1.w, $tmp1.w																								; LINEINFO(flesh_interior_blended_pass_dx8_vs11.vsh)(61)\n";
push @output, "rcp $tmp1.w, $tmp1.w																								; LINEINFO(flesh_interior_blended_pass_dx8_vs11.vsh)(62)\n";
push @output, "mul $tmp1.w, $tmp1.w, $SHADER_SPECIFIC_CONST_2.w																								; LINEINFO(flesh_interior_blended_pass_dx8_vs11.vsh)(63)\n";
push @output, "min $flEffect, $flEffect, $tmp1.w																								; LINEINFO(flesh_interior_blended_pass_dx8_vs11.vsh)(64)\n";
push @output, "sub $tmp1.xyz, $worldPos, $SHADER_SPECIFIC_CONST_3																								; LINEINFO(flesh_interior_blended_pass_dx8_vs11.vsh)(66)\n";
push @output, "dp3 $tmp1.w, $tmp1, $tmp1																								; LINEINFO(flesh_interior_blended_pass_dx8_vs11.vsh)(67)\n";
push @output, "rsq $tmp1.w, $tmp1.w																								; LINEINFO(flesh_interior_blended_pass_dx8_vs11.vsh)(68)\n";
push @output, "rcp $tmp1.w, $tmp1.w																								; LINEINFO(flesh_interior_blended_pass_dx8_vs11.vsh)(69)\n";
push @output, "mul $tmp1.w, $tmp1.w, $SHADER_SPECIFIC_CONST_3.w																								; LINEINFO(flesh_interior_blended_pass_dx8_vs11.vsh)(70)\n";
push @output, "min $flEffect, $flEffect, $tmp1.w																								; LINEINFO(flesh_interior_blended_pass_dx8_vs11.vsh)(71)\n";
push @output, "sub $tmp1.xyz, $worldPos, $SHADER_SPECIFIC_CONST_4																								; LINEINFO(flesh_interior_blended_pass_dx8_vs11.vsh)(73)\n";
push @output, "dp3 $tmp1.w, $tmp1, $tmp1																								; LINEINFO(flesh_interior_blended_pass_dx8_vs11.vsh)(74)\n";
push @output, "rsq $tmp1.w, $tmp1.w																								; LINEINFO(flesh_interior_blended_pass_dx8_vs11.vsh)(75)\n";
push @output, "rcp $tmp1.w, $tmp1.w																								; LINEINFO(flesh_interior_blended_pass_dx8_vs11.vsh)(76)\n";
push @output, "mul $tmp1.w, $tmp1.w, $SHADER_SPECIFIC_CONST_4.w																								; LINEINFO(flesh_interior_blended_pass_dx8_vs11.vsh)(77)\n";
push @output, "min $flEffect, $flEffect, $tmp1.w																								; LINEINFO(flesh_interior_blended_pass_dx8_vs11.vsh)(78)\n";
push @output, "mov oD0, $flEffect																								; LINEINFO(flesh_interior_blended_pass_dx8_vs11.vsh)(80)\n";
push @output, "; float3 vWorldViewVector = normalize( vWorldPosition.xyz - cEyePos.xyz );																								; LINEINFO(flesh_interior_blended_pass_dx8_vs11.vsh)(82)\n";
push @output, "; o.flDistanceToEffectCenter_flFresnelEffect.y = pow( saturate( dot( -vWorldViewVector.xyz, vWorldNormal.xyz ) ), 1.5f );																								; LINEINFO(flesh_interior_blended_pass_dx8_vs11.vsh)(83)\n";
push @output, "sub $tmp1, $worldPos, $cEyePos																								; LINEINFO(flesh_interior_blended_pass_dx8_vs11.vsh)(85)\n";
&Normalize( $tmp1 );																								
push @output, "dp3 $tmp1, -$tmp1, $worldNormal																								; LINEINFO(flesh_interior_blended_pass_dx8_vs11.vsh)(87)\n";
push @output, "max $tmp1, $tmp1, $cZero																								; LINEINFO(flesh_interior_blended_pass_dx8_vs11.vsh)(88)\n";
push @output, "mul $tmp1, $tmp1, $tmp1																								; LINEINFO(flesh_interior_blended_pass_dx8_vs11.vsh)(89)\n";
push @output, "mov oD1, $tmp1																								; LINEINFO(flesh_interior_blended_pass_dx8_vs11.vsh)(90)\n";
&FreeRegister( \$tmp1, "\$tmp1" );
&FreeRegister( \$flEffect, "\$flEffect" );
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(flesh_interior_blended_pass_dx8_vs11.vsh)(95)\n";
push @output, "; Texture coordinates																								; LINEINFO(flesh_interior_blended_pass_dx8_vs11.vsh)(96)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(flesh_interior_blended_pass_dx8_vs11.vsh)(97)\n";
push @output, "mov oT0.xy, $vTexCoord0																								; LINEINFO(flesh_interior_blended_pass_dx8_vs11.vsh)(99)\n";
local( $tmp2 ); &AllocateRegister( \$tmp2, "\$tmp2" );
push @output, "dp4 $tmp2.x, $vTexCoord0, $SHADER_SPECIFIC_CONST_0																								; LINEINFO(flesh_interior_blended_pass_dx8_vs11.vsh)(103)\n";
push @output, "dp4 $tmp2.y, $vTexCoord0, $SHADER_SPECIFIC_CONST_1																								; LINEINFO(flesh_interior_blended_pass_dx8_vs11.vsh)(104)\n";
push @output, "add oT1.xy, $tmp2, $SHADER_SPECIFIC_CONST_4																								; LINEINFO(flesh_interior_blended_pass_dx8_vs11.vsh)(106)\n";
&FreeRegister( \$tmp2, "\$tmp2" );
push @output, "; YUCK!  This is to make texcoords continuous for mat_softwaretl																								; LINEINFO(flesh_interior_blended_pass_dx8_vs11.vsh)(110)\n";
push @output, "mov oT2, $cZero																								; LINEINFO(flesh_interior_blended_pass_dx8_vs11.vsh)(111)\n";
