...
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(lightmappedgeneric_bumpmappedenvmap_ps14.vsh)(5)\n";
push @output, "; Shader specific constant:																								; LINEINFO(lightmappedgeneric_bumpmappedenvmap_ps14.vsh)(6)\n";
 	 push @output, ";	 $SHADER_SPECIFIC_CONST_5	 = [sOffset, tOffset, 0, 0]																								; LINEINFO(lightmappedgeneric_bumpmappedenvmap_ps14.vsh)(7)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(lightmappedgeneric_bumpmappedenvmap_ps14.vsh)(8)\n";
...
push @output, "; Vertex blending																								; LINEINFO(lightmappedgeneric_bumpmappedenvmap_ps14.vsh)(13)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(lightmappedgeneric_bumpmappedenvmap_ps14.vsh)(14)\n";
&AllocateRegister( \$worldPos, "\$worldPos" );																								
push @output, "; Transform position from object to world																								; LINEINFO(lightmappedgeneric_bumpmappedenvmap_ps14.vsh)(18)\n";
push @output, "dp4 $worldPos.x, $vPos, $cModel0																								; LINEINFO(lightmappedgeneric_bumpmappedenvmap_ps14.vsh)(19)\n";
push @output, "dp4 $worldPos.y, $vPos, $cModel1																								; LINEINFO(lightmappedgeneric_bumpmappedenvmap_ps14.vsh)(20)\n";
push @output, "dp4 $worldPos.z, $vPos, $cModel2																								; LINEINFO(lightmappedgeneric_bumpmappedenvmap_ps14.vsh)(21)\n";
&AllocateRegister( \$projPos, "\$projPos" );																								
push @output, "; Transform position from object to projection space																								; LINEINFO(lightmappedgeneric_bumpmappedenvmap_ps14.vsh)(25)\n";
push @output, "dp4 $projPos.x, $vPos, $cModelViewProj0																								; LINEINFO(lightmappedgeneric_bumpmappedenvmap_ps14.vsh)(26)\n";
push @output, "dp4 $projPos.y, $vPos, $cModelViewProj1																								; LINEINFO(lightmappedgeneric_bumpmappedenvmap_ps14.vsh)(27)\n";
push @output, "dp4 $projPos.z, $vPos, $cModelViewProj2																								; LINEINFO(lightmappedgeneric_bumpmappedenvmap_ps14.vsh)(28)\n";
push @output, "dp4 $projPos.w, $vPos, $cModelViewProj3																								; LINEINFO(lightmappedgeneric_bumpmappedenvmap_ps14.vsh)(29)\n";
push @output, "mov oPos, $projPos																								; LINEINFO(lightmappedgeneric_bumpmappedenvmap_ps14.vsh)(31)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(lightmappedgeneric_bumpmappedenvmap_ps14.vsh)(33)\n";
push @output, "; Fog																								; LINEINFO(lightmappedgeneric_bumpmappedenvmap_ps14.vsh)(34)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(lightmappedgeneric_bumpmappedenvmap_ps14.vsh)(35)\n";
&CalcFog( $worldPos, $projPos );																								
&FreeRegister( \$projPos, "\$projPos" );																								
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(lightmappedgeneric_bumpmappedenvmap_ps14.vsh)(41)\n";
push @output, "; Lighting																								; LINEINFO(lightmappedgeneric_bumpmappedenvmap_ps14.vsh)(42)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(lightmappedgeneric_bumpmappedenvmap_ps14.vsh)(43)\n";
push @output, "; Transform tangent space basis vectors to env map space (world space)																								; LINEINFO(lightmappedgeneric_bumpmappedenvmap_ps14.vsh)(45)\n";
push @output, "; This will produce a set of vectors mapping from tangent space to env space																								; LINEINFO(lightmappedgeneric_bumpmappedenvmap_ps14.vsh)(46)\n";
push @output, "; We'll use this to transform normals from the normal map from tangent space																								; LINEINFO(lightmappedgeneric_bumpmappedenvmap_ps14.vsh)(47)\n";
push @output, "; to environment map space. 																								; LINEINFO(lightmappedgeneric_bumpmappedenvmap_ps14.vsh)(48)\n";
push @output, "; NOTE: use dp3 here since the basis vectors are vectors, not points																								; LINEINFO(lightmappedgeneric_bumpmappedenvmap_ps14.vsh)(49)\n";
push @output, "dp3 oT1.x, $vTangentS, $cModel0																								; LINEINFO(lightmappedgeneric_bumpmappedenvmap_ps14.vsh)(51)\n";
push @output, "dp3 oT2.x, $vTangentS, $cModel1																								; LINEINFO(lightmappedgeneric_bumpmappedenvmap_ps14.vsh)(52)\n";
push @output, "dp3 oT3.x, $vTangentS, $cModel2																								; LINEINFO(lightmappedgeneric_bumpmappedenvmap_ps14.vsh)(53)\n";
push @output, "dp3 oT1.y, $vTangentT, $cModel0																								; LINEINFO(lightmappedgeneric_bumpmappedenvmap_ps14.vsh)(55)\n";
push @output, "dp3 oT2.y, $vTangentT, $cModel1																								; LINEINFO(lightmappedgeneric_bumpmappedenvmap_ps14.vsh)(56)\n";
push @output, "dp3 oT3.y, $vTangentT, $cModel2																								; LINEINFO(lightmappedgeneric_bumpmappedenvmap_ps14.vsh)(57)\n";
push @output, "dp3 oT1.z, $vNormal, $cModel0																								; LINEINFO(lightmappedgeneric_bumpmappedenvmap_ps14.vsh)(59)\n";
push @output, "dp3 oT2.z, $vNormal, $cModel1																								; LINEINFO(lightmappedgeneric_bumpmappedenvmap_ps14.vsh)(60)\n";
push @output, "dp3 oT3.z, $vNormal, $cModel2																								; LINEINFO(lightmappedgeneric_bumpmappedenvmap_ps14.vsh)(61)\n";
push @output, "; Compute the vector from vertex to camera																								; LINEINFO(lightmappedgeneric_bumpmappedenvmap_ps14.vsh)(63)\n";
&AllocateRegister( \$worldEyeVect, "\$worldEyeVect" );																								
push @output, "sub $worldEyeVect.xyz, $cEyePos, $worldPos																								; LINEINFO(lightmappedgeneric_bumpmappedenvmap_ps14.vsh)(65)\n";
&FreeRegister( \$worldPos, "\$worldPos" );																								
push @output, "; eye vector																								; LINEINFO(lightmappedgeneric_bumpmappedenvmap_ps14.vsh)(68)\n";
push @output, "mov oT4.xyz, $worldEyeVect																								; LINEINFO(lightmappedgeneric_bumpmappedenvmap_ps14.vsh)(69)\n";
local( $tangentEyeVect ); &AllocateRegister( \$tangentEyeVect, "\$tangentEyeVect" );
push @output, "; transform the eye vector to tangent space																								; LINEINFO(lightmappedgeneric_bumpmappedenvmap_ps14.vsh)(73)\n";
push @output, "dp3 $tangentEyeVect.x, $worldEyeVect, $vTangentS																								; LINEINFO(lightmappedgeneric_bumpmappedenvmap_ps14.vsh)(74)\n";
push @output, "dp3 $tangentEyeVect.y, $worldEyeVect, $vTangentT																								; LINEINFO(lightmappedgeneric_bumpmappedenvmap_ps14.vsh)(75)\n";
push @output, "dp3 $tangentEyeVect.z, $worldEyeVect, $vNormal																								; LINEINFO(lightmappedgeneric_bumpmappedenvmap_ps14.vsh)(76)\n";
&FreeRegister( \$worldEyeVect, "\$worldEyeVect" );																								
&Normalize( $tangentEyeVect );																								
push @output, "; stick the tangent space eye vector into oD0																								; LINEINFO(lightmappedgeneric_bumpmappedenvmap_ps14.vsh)(82)\n";
push @output, "mad oD0.xyz, $tangentEyeVect, $cHalf, $cHalf																								; LINEINFO(lightmappedgeneric_bumpmappedenvmap_ps14.vsh)(83)\n";
&FreeRegister( \$tangentEyeVect, "\$tangentEyeVect" );																								
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(lightmappedgeneric_bumpmappedenvmap_ps14.vsh)(87)\n";
push @output, "; Texture coordinates																								; LINEINFO(lightmappedgeneric_bumpmappedenvmap_ps14.vsh)(88)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(lightmappedgeneric_bumpmappedenvmap_ps14.vsh)(89)\n";
push @output, "dp4 oT0.x, $vTexCoord0, $SHADER_SPECIFIC_CONST_0																								; LINEINFO(lightmappedgeneric_bumpmappedenvmap_ps14.vsh)(90)\n";
push @output, "dp4 oT0.y, $vTexCoord0, $SHADER_SPECIFIC_CONST_1																								; LINEINFO(lightmappedgeneric_bumpmappedenvmap_ps14.vsh)(91)\n";
