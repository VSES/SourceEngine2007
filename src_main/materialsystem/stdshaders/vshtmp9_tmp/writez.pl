...
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(writez.vsh)(7)\n";
 	 push @output, ";	 $SHADER_SPECIFIC_CONST_0-$SHADER_SPECIFIC_CONST_1 = Base texture transform																								; LINEINFO(writez.vsh)(8)\n";
     push @output, ";    $SHADER_SPECIFIC_CONST_2-$SHADER_SPECIFIC_CONST_3 = Mask texture transform																								; LINEINFO(writez.vsh)(9)\n";
 	 push @output, ";	 $SHADER_SPECIFIC_CONST_4	 = Modulation color 																								; LINEINFO(writez.vsh)(10)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(writez.vsh)(11)\n";
&AllocateRegister( \$projPos, "\$projPos" );																								
push @output, "dp4 $projPos.x, $vPos, $cModelViewProj0																								; LINEINFO(writez.vsh)(15)\n";
push @output, "dp4 $projPos.y, $vPos, $cModelViewProj1																								; LINEINFO(writez.vsh)(16)\n";
push @output, "dp4 $projPos.z, $vPos, $cModelViewProj2																								; LINEINFO(writez.vsh)(17)\n";
push @output, "dp4 $projPos.w, $vPos, $cModelViewProj3																								; LINEINFO(writez.vsh)(18)\n";
push @output, "mov oPos, $projPos																								; LINEINFO(writez.vsh)(19)\n";
&FreeRegister( \$projPos, "\$projPos" );																								
