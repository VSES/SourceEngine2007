push @output, "vs.1.1																								; LINEINFO(lightmappedgeneric_vs11.vsh)(1)\n";
...
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(LightmappedGeneric_inc.vsh)(3)\n";
 	 push @output, ";	 $SHADER_SPECIFIC_CONST_0-$SHADER_SPECIFIC_CONST_1 = Base texture transform																								; LINEINFO(LightmappedGeneric_inc.vsh)(4)\n";
     push @output, ";    $SHADER_SPECIFIC_CONST_2-$SHADER_SPECIFIC_CONST_3 = Mask texture transform																								; LINEINFO(LightmappedGeneric_inc.vsh)(5)\n";
 	 push @output, ";	 $SHADER_SPECIFIC_CONST_4	 = Modulation color 																								; LINEINFO(LightmappedGeneric_inc.vsh)(6)\n";
...
{																								
	...
	push @output, "	dp4 oT0.x, $vTexCoord0, $SHADER_SPECIFIC_CONST_0																								; LINEINFO(LightmappedGeneric_inc.vsh)(41)\n";
	push @output, "	dp4 oT0.y, $vTexCoord0, $SHADER_SPECIFIC_CONST_1																								; LINEINFO(LightmappedGeneric_inc.vsh)(42)\n";
	...
	{																								
		...
		push @output, "		dp4 oT3.x, $vTexCoord0, $SHADER_SPECIFIC_CONST_2	; FIXME																								; LINEINFO(LightmappedGeneric_inc.vsh)(85)\n";
		push @output, "		dp4 oT3.y, $vTexCoord0, $SHADER_SPECIFIC_CONST_3	; FIXME																								; LINEINFO(LightmappedGeneric_inc.vsh)(86)\n";
#		&FreeRegister( \$worldPos, "\$worldPos" );																								
	...
	if( $detail )																								
	{																								
		push @output, "		dp4 oT2.x, $vTexCoord0, $SHADER_SPECIFIC_CONST_4		; FIXME																								; LINEINFO(LightmappedGeneric_inc.vsh)(96)\n";
		push @output, "		dp4 oT2.y, $vTexCoord0, $SHADER_SPECIFIC_CONST_5		; FIXME																								; LINEINFO(LightmappedGeneric_inc.vsh)(97)\n";
	}																								
	if( $vertexcolor )																								
	{																								
