...
push @output, "; Vertex blending																								; LINEINFO(lightmappedgeneric_bumpmappedlightmap.vsh)(8)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(lightmappedgeneric_bumpmappedlightmap.vsh)(9)\n";
&AllocateRegister( \$projPos, "\$projPos" );																								
push @output, "; Transform position from object to projection space																								; LINEINFO(lightmappedgeneric_bumpmappedlightmap.vsh)(13)\n";
push @output, "dp4 $projPos.x, $vPos, $cModelViewProj0																								; LINEINFO(lightmappedgeneric_bumpmappedlightmap.vsh)(14)\n";
push @output, "dp4 $projPos.y, $vPos, $cModelViewProj1																								; LINEINFO(lightmappedgeneric_bumpmappedlightmap.vsh)(15)\n";
push @output, "dp4 $projPos.z, $vPos, $cModelViewProj2																								; LINEINFO(lightmappedgeneric_bumpmappedlightmap.vsh)(16)\n";
push @output, "dp4 $projPos.w, $vPos, $cModelViewProj3																								; LINEINFO(lightmappedgeneric_bumpmappedlightmap.vsh)(17)\n";
push @output, "mov oPos, $projPos																								; LINEINFO(lightmappedgeneric_bumpmappedlightmap.vsh)(19)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(lightmappedgeneric_bumpmappedlightmap.vsh)(21)\n";
push @output, "; Fog																								; LINEINFO(lightmappedgeneric_bumpmappedlightmap.vsh)(22)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(lightmappedgeneric_bumpmappedlightmap.vsh)(23)\n";
local( $worldPos ); &AllocateRegister( \$worldPos, "\$worldPos" );
if( $DOWATERFOG == 1 )																								
{																								
	push @output, "	; Get the worldpos z component only since that's all we need for height fog																								; LINEINFO(lightmappedgeneric_bumpmappedlightmap.vsh)(28)\n";
	push @output, "	dp4 $worldPos.z, $vPos, $cModel2																								; LINEINFO(lightmappedgeneric_bumpmappedlightmap.vsh)(29)\n";
}																								
&CalcFog( $worldPos, $projPos );																								
&FreeRegister( \$worldPos, "\$worldPos" );
&FreeRegister( \$projPos, "\$projPos" );																								
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(lightmappedgeneric_bumpmappedlightmap.vsh)(36)\n";
push @output, "; Texture coordinates																								; LINEINFO(lightmappedgeneric_bumpmappedlightmap.vsh)(37)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(lightmappedgeneric_bumpmappedlightmap.vsh)(38)\n";
push @output, "; Compute the texture coordinates given the offset between																								; LINEINFO(lightmappedgeneric_bumpmappedlightmap.vsh)(40)\n";
push @output, "; each bumped lightmap																								; LINEINFO(lightmappedgeneric_bumpmappedlightmap.vsh)(41)\n";
&AllocateRegister( \$offset, "\$offset" );																								
push @output, "mov $offset.xy, $vTexCoord2																								; LINEINFO(lightmappedgeneric_bumpmappedlightmap.vsh)(43)\n";
push @output, "dp4 oT0.x, $vTexCoord0, $SHADER_SPECIFIC_CONST_0																								; LINEINFO(lightmappedgeneric_bumpmappedlightmap.vsh)(44)\n";
push @output, "dp4 oT0.y, $vTexCoord0, $SHADER_SPECIFIC_CONST_1																								; LINEINFO(lightmappedgeneric_bumpmappedlightmap.vsh)(45)\n";
push @output, "add oT1.xy, $offset, $vTexCoord1																								; LINEINFO(lightmappedgeneric_bumpmappedlightmap.vsh)(46)\n";
push @output, "mad oT2.xy, $offset, $cTwo, $vTexCoord1																								; LINEINFO(lightmappedgeneric_bumpmappedlightmap.vsh)(47)\n";
push @output, "; make a 3																								; LINEINFO(lightmappedgeneric_bumpmappedlightmap.vsh)(48)\n";
local( $three ); &AllocateRegister( \$three, "\$three" );
push @output, "add $three, $cOne, $cTwo																								; LINEINFO(lightmappedgeneric_bumpmappedlightmap.vsh)(50)\n";
push @output, "mad oT3.xy, $offset, $three, $vTexCoord1																								; LINEINFO(lightmappedgeneric_bumpmappedlightmap.vsh)(51)\n";
