...
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(fillrate.vsh)(6)\n";
push @output, "; Constants specified by the app																								; LINEINFO(fillrate.vsh)(7)\n";
     push @output, ";    c0      = (0, 1, 2, 0.5)																								; LINEINFO(fillrate.vsh)(8)\n";
 	 push @output, ";	 c1		 = (1/2.2, 3, 255, overbright factor)																								; LINEINFO(fillrate.vsh)(9)\n";
     push @output, ";    c2      = camera position *in world space*																								; LINEINFO(fillrate.vsh)(10)\n";
     push @output, ";    c4-c7   = modelViewProj matrix	(transpose)																								; LINEINFO(fillrate.vsh)(11)\n";
     push @output, ";    c8-c11  = ViewProj matrix (transpose)																								; LINEINFO(fillrate.vsh)(12)\n";
     push @output, ";    c12-c15 = model->view matrix (transpose)																								; LINEINFO(fillrate.vsh)(13)\n";
 	 push @output, ";	 c16	 = [fogStart, fogEnd, fogRange, 1.0/fogRange]																								; LINEINFO(fillrate.vsh)(14)\n";
 	 push @output, ";	 $SHADER_SPECIFIC_CONST_0-$SHADER_SPECIFIC_CONST_1 = Base texture transform																								; LINEINFO(fillrate.vsh)(15)\n";
     push @output, ";    $SHADER_SPECIFIC_CONST_2-$SHADER_SPECIFIC_CONST_3 = Mask texture transform																								; LINEINFO(fillrate.vsh)(16)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(fillrate.vsh)(17)\n";
...
push @output, "; Vertex blending																								; LINEINFO(fillrate.vsh)(22)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(fillrate.vsh)(23)\n";
&AllocateRegister( \$worldPos, "\$worldPos" );																								
&SkinPosition( $worldPos );																								
push @output, "; Transform the position from world to view space																								; LINEINFO(fillrate.vsh)(28)\n";
push @output, "dp4 oPos.x, $worldPos, $cViewProj0																								; LINEINFO(fillrate.vsh)(29)\n";
push @output, "dp4 oPos.y, $worldPos, $cViewProj1																								; LINEINFO(fillrate.vsh)(30)\n";
push @output, "dp4 oPos.z, $worldPos, $cViewProj2																								; LINEINFO(fillrate.vsh)(31)\n";
push @output, "dp4 oPos.w, $worldPos, $cViewProj3																								; LINEINFO(fillrate.vsh)(32)\n";
