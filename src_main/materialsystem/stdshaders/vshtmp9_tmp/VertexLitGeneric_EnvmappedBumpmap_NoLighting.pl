...
push @output, "; Shader specific constant:																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_NoLighting.vsh)(7)\n";
 	 push @output, ";	 $SHADER_SPECIFIC_CONST_5	 = [sOffset, tOffset, 0, 0]																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_NoLighting.vsh)(8)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_NoLighting.vsh)(9)\n";
...
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_NoLighting.vsh)(13)\n";
push @output, "; Vertex blending																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_NoLighting.vsh)(14)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_NoLighting.vsh)(15)\n";
...
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_NoLighting.vsh)(25)\n";
push @output, "; Transform the position from world to proj space																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_NoLighting.vsh)(26)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_NoLighting.vsh)(27)\n";
&AllocateRegister( \$projPos, "\$projPos" );																								
push @output, "dp4 $projPos.x, $worldPos, $cViewProj0																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_NoLighting.vsh)(31)\n";
push @output, "dp4 $projPos.y, $worldPos, $cViewProj1																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_NoLighting.vsh)(32)\n";
push @output, "dp4 $projPos.z, $worldPos, $cViewProj2																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_NoLighting.vsh)(33)\n";
push @output, "dp4 $projPos.w, $worldPos, $cViewProj3																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_NoLighting.vsh)(34)\n";
push @output, "mov oPos, $projPos																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_NoLighting.vsh)(35)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_NoLighting.vsh)(37)\n";
push @output, "; Fog																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_NoLighting.vsh)(38)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_NoLighting.vsh)(39)\n";
&CalcFog( $worldPos, $projPos );																								
&FreeRegister( \$projPos, "\$projPos" );																								
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_NoLighting.vsh)(44)\n";
push @output, "; Lighting																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_NoLighting.vsh)(45)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_NoLighting.vsh)(46)\n";
push @output, "; Transform tangent space basis vectors to env map space (world space)																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_NoLighting.vsh)(48)\n";
push @output, "; This will produce a set of vectors mapping from tangent space to env space																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_NoLighting.vsh)(49)\n";
push @output, "; We'll use this to transform normals from the normal map from tangent space																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_NoLighting.vsh)(50)\n";
push @output, "; to environment map space. 																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_NoLighting.vsh)(51)\n";
push @output, "; NOTE: use dp3 here since the basis vectors are vectors, not points																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_NoLighting.vsh)(52)\n";
push @output, "; svect																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_NoLighting.vsh)(54)\n";
push @output, "mov oT1.x, $worldTangentS.x																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_NoLighting.vsh)(55)\n";
push @output, "mov oT2.x, $worldTangentS.y																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_NoLighting.vsh)(56)\n";
push @output, "mov oT3.x, $worldTangentS.z																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_NoLighting.vsh)(57)\n";
&FreeRegister( \$worldTangentS, "\$worldTangentS" );																								
push @output, "; tvect																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_NoLighting.vsh)(60)\n";
push @output, "mov oT1.y, $worldTangentT.x																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_NoLighting.vsh)(61)\n";
push @output, "mov oT2.y, $worldTangentT.y																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_NoLighting.vsh)(62)\n";
push @output, "mov oT3.y, $worldTangentT.z																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_NoLighting.vsh)(63)\n";
&FreeRegister( \$worldTangentT, "\$worldTangentT" );																								
push @output, "; normal																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_NoLighting.vsh)(66)\n";
push @output, "mov oT1.z, $worldNormal.x																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_NoLighting.vsh)(67)\n";
push @output, "mov oT2.z, $worldNormal.y																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_NoLighting.vsh)(68)\n";
push @output, "mov oT3.z, $worldNormal.z																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_NoLighting.vsh)(69)\n";
&FreeRegister( \$worldNormal, "\$worldNormal" );																								
push @output, "; Compute the vector from vertex to camera																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_NoLighting.vsh)(73)\n";
&AllocateRegister( \$eyeVector, "\$eyeVector" );																								
push @output, "sub $eyeVector.xyz, $cEyePos, $worldPos  																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_NoLighting.vsh)(75)\n";
&FreeRegister( \$worldPos, "\$worldPos" );																								
push @output, "; Move it into the w component of the texture coords, as the wacky																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_NoLighting.vsh)(79)\n";
push @output, "; pixel shader wants it there.																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_NoLighting.vsh)(80)\n";
push @output, "mov oT1.w, $eyeVector.x																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_NoLighting.vsh)(81)\n";
push @output, "mov oT2.w, $eyeVector.y																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_NoLighting.vsh)(82)\n";
push @output, "mov oT3.w, $eyeVector.z																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_NoLighting.vsh)(83)\n";
&FreeRegister( \$eyeVector, "\$eyeVector" );																								
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_NoLighting.vsh)(87)\n";
push @output, "; Texture coordinates																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_NoLighting.vsh)(88)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_NoLighting.vsh)(89)\n";
push @output, "dp4 oT0.x, $vTexCoord0, $SHADER_SPECIFIC_CONST_4																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_NoLighting.vsh)(90)\n";
push @output, "dp4 oT0.y, $vTexCoord0, $SHADER_SPECIFIC_CONST_5																								; LINEINFO(VertexLitGeneric_EnvmappedBumpmap_NoLighting.vsh)(91)\n";
