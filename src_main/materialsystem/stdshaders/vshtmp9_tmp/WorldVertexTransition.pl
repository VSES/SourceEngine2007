...
&AllocateRegister( \$projPos, "\$projPos" );																								
push @output, "dp4 $projPos.x, $vPos, $cModelViewProj0																								; LINEINFO(WorldVertexTransition.vsh)(11)\n";
push @output, "dp4 $projPos.y, $vPos, $cModelViewProj1																								; LINEINFO(WorldVertexTransition.vsh)(12)\n";
push @output, "dp4 $projPos.z, $vPos, $cModelViewProj2																								; LINEINFO(WorldVertexTransition.vsh)(13)\n";
push @output, "dp4 $projPos.w, $vPos, $cModelViewProj3																								; LINEINFO(WorldVertexTransition.vsh)(14)\n";
push @output, "mov oPos, $projPos																								; LINEINFO(WorldVertexTransition.vsh)(15)\n";
&AllocateRegister( \$worldPos, "\$worldPos" );																								
push @output, "; garymcthack																								; LINEINFO(WorldVertexTransition.vsh)(19)\n";
push @output, "dp4 $worldPos.z, $vPos, $cModel2																								; LINEINFO(WorldVertexTransition.vsh)(20)\n";
&CalcFog( $worldPos, $projPos );																								
&FreeRegister( \$worldPos, "\$worldPos" );																								
&FreeRegister( \$projPos, "\$projPos" );																								
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(WorldVertexTransition.vsh)(27)\n";
push @output, "; Texture coordinates																								; LINEINFO(WorldVertexTransition.vsh)(28)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(WorldVertexTransition.vsh)(29)\n";
push @output, "; base texcoords																								; LINEINFO(WorldVertexTransition.vsh)(30)\n";
push @output, "dp4 oT0.x, $vTexCoord0, $SHADER_SPECIFIC_CONST_0																								; LINEINFO(WorldVertexTransition.vsh)(31)\n";
push @output, "dp4 oT0.y, $vTexCoord0, $SHADER_SPECIFIC_CONST_1																								; LINEINFO(WorldVertexTransition.vsh)(32)\n";
push @output, "dp4 oT1.x, $vTexCoord0, $SHADER_SPECIFIC_CONST_2																								; LINEINFO(WorldVertexTransition.vsh)(34)\n";
push @output, "dp4 oT1.y, $vTexCoord0, $SHADER_SPECIFIC_CONST_3																								; LINEINFO(WorldVertexTransition.vsh)(35)\n";
...
push @output, "; detail																								; LINEINFO(WorldVertexTransition.vsh)(40)\n";
push @output, "dp4 oT3.x, $vTexCoord0, $SHADER_SPECIFIC_CONST_4																								; LINEINFO(WorldVertexTransition.vsh)(41)\n";
push @output, "dp4 oT3.y, $vTexCoord0, $SHADER_SPECIFIC_CONST_5																								; LINEINFO(WorldVertexTransition.vsh)(42)\n";
push @output, "; Now the basetexture/basetexture2 blend uses vertex color, so send it into the psh.																								; LINEINFO(WorldVertexTransition.vsh)(44)\n";
push @output, "mov oD0, $vColor																								; LINEINFO(WorldVertexTransition.vsh)(45)\n";
