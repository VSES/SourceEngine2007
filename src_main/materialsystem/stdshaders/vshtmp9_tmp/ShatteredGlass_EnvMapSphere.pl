push @output, "vs.1.1																								; LINEINFO(ShatteredGlass_EnvMapSphere.vsh)(1)\n";
...
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(ShatteredGlass_inc.vsh)(3)\n";
 	 push @output, ";	 $SHADER_SPECIFIC_CONST_0-$SHADER_SPECIFIC_CONST_1 = Base texture transform + envmap mask transform																								; LINEINFO(ShatteredGlass_inc.vsh)(4)\n";
     push @output, ";    $SHADER_SPECIFIC_CONST_2-$SHADER_SPECIFIC_CONST_3 = Detail texture transform																								; LINEINFO(ShatteredGlass_inc.vsh)(5)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(ShatteredGlass_inc.vsh)(6)\n";
sub ShatteredGlass																								
{																								
	local( $detail ) = shift;																								
	local( $envmap ) = shift;																								
	...
	&AllocateRegister( \$projPos, "\$projPos" );																								
	push @output, "	dp4 $projPos.x, $vPos, $cModelViewProj0																								; LINEINFO(ShatteredGlass_inc.vsh)(20)\n";
	push @output, "	dp4 $projPos.y, $vPos, $cModelViewProj1																								; LINEINFO(ShatteredGlass_inc.vsh)(21)\n";
	push @output, "	dp4 $projPos.z, $vPos, $cModelViewProj2																								; LINEINFO(ShatteredGlass_inc.vsh)(22)\n";
	push @output, "	dp4 $projPos.w, $vPos, $cModelViewProj3																								; LINEINFO(ShatteredGlass_inc.vsh)(23)\n";
	push @output, "	mov oPos, $projPos																								; LINEINFO(ShatteredGlass_inc.vsh)(24)\n";
	&AllocateRegister( \$worldPos, "\$worldPos" );																								
	if( $DOWATERFOG == 1 )																								
	{																								
		push @output, "		; Get the worldpos z component only since that's all we need for height fog																								; LINEINFO(ShatteredGlass_inc.vsh)(30)\n";
		push @output, "		dp4 $worldPos.z, $vPos, $cModel2																								; LINEINFO(ShatteredGlass_inc.vsh)(31)\n";
	}																								
	&CalcFog( $worldPos, $projPos );																								
	&FreeRegister( \$projPos, "\$projPos" );																								
	push @output, "	;------------------------------------------------------------------------------																								; LINEINFO(ShatteredGlass_inc.vsh)(36)\n";
	push @output, "	; Texture coordinates																								; LINEINFO(ShatteredGlass_inc.vsh)(37)\n";
	push @output, "	;------------------------------------------------------------------------------																								; LINEINFO(ShatteredGlass_inc.vsh)(38)\n";
	push @output, "	; base texcoords																								; LINEINFO(ShatteredGlass_inc.vsh)(39)\n";
	push @output, "	dp4 oT0.x, $vTexCoord0, $SHADER_SPECIFIC_CONST_0																								; LINEINFO(ShatteredGlass_inc.vsh)(40)\n";
	push @output, "	dp4 oT0.y, $vTexCoord0, $SHADER_SPECIFIC_CONST_1																								; LINEINFO(ShatteredGlass_inc.vsh)(41)\n";
	push @output, "	; lightmap texcoords																								; LINEINFO(ShatteredGlass_inc.vsh)(43)\n";
	push @output, "	mov oT1, $vTexCoord1																								; LINEINFO(ShatteredGlass_inc.vsh)(44)\n";
	if( $envmap )																								
	{																								
		&AllocateRegister( \$worldNormal, "\$worldNormal" );																								
		push @output, "		; Transform the position + normal to world space																								; LINEINFO(ShatteredGlass_inc.vsh)(50)\n";
		push @output, "		dp4 $worldPos.x, $vPos, $cModel0																								; LINEINFO(ShatteredGlass_inc.vsh)(51)\n";
		push @output, "		dp4 $worldPos.y, $vPos, $cModel1																								; LINEINFO(ShatteredGlass_inc.vsh)(52)\n";
		if( $DOWATERFOG == 0 )																								
		{																								
			push @output, "			dp4 $worldPos.z, $vPos, $cModel2																								; LINEINFO(ShatteredGlass_inc.vsh)(55)\n";
		}																								
		push @output, "		dp3 $worldNormal.x, $vNormal, $cModel0																								; LINEINFO(ShatteredGlass_inc.vsh)(58)\n";
		push @output, "		dp3 $worldNormal.y, $vNormal, $cModel1																								; LINEINFO(ShatteredGlass_inc.vsh)(59)\n";
		push @output, "		dp3 $worldNormal.z, $vNormal, $cModel2																								; LINEINFO(ShatteredGlass_inc.vsh)(60)\n";
		...
		{																								
			...
			push @output, "			; transform reflection vector into view space																								; LINEINFO(ShatteredGlass_inc.vsh)(66)\n";
			push @output, "			dp3 oT2.x, $reflectionVector, $cViewModel0																								; LINEINFO(ShatteredGlass_inc.vsh)(67)\n";
			push @output, "			dp3 oT2.y, $reflectionVector, $cViewModel1																								; LINEINFO(ShatteredGlass_inc.vsh)(68)\n";
			push @output, "			dp3 oT2.z, $reflectionVector, $cViewModel2																								; LINEINFO(ShatteredGlass_inc.vsh)(69)\n";
	...
	if( $detail )																								
	{																								
		push @output, "		dp4 oT3.x, $vTexCoord2, $SHADER_SPECIFIC_CONST_2																								; LINEINFO(ShatteredGlass_inc.vsh)(91)\n";
		push @output, "		dp4 oT3.y, $vTexCoord2, $SHADER_SPECIFIC_CONST_3																								; LINEINFO(ShatteredGlass_inc.vsh)(92)\n";
	}																								
	if( $vertexcolor )																								
	{																								
		push @output, "		; Modulation color																								; LINEINFO(ShatteredGlass_inc.vsh)(97)\n";
		push @output, "		mul oD0, $vColor, $cModulationColor																								; LINEINFO(ShatteredGlass_inc.vsh)(98)\n";
	}																								
	else																								
	{																								
		push @output, "		; Modulation color																								; LINEINFO(ShatteredGlass_inc.vsh)(102)\n";
		push @output, "		mov oD0, $cModulationColor																								; LINEINFO(ShatteredGlass_inc.vsh)(103)\n";
	}																								
}																								
$detail = 1;																								
$envmap = 1;																								
