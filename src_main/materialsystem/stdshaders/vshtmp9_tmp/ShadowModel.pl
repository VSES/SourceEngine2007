...
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(ShadowModel.vsh)(6)\n";
push @output, "; Constants specified by the app																								; LINEINFO(ShadowModel.vsh)(7)\n";
 	 push @output, ";	 $SHADER_SPECIFIC_CONST_0-$SHADER_SPECIFIC_CONST_2 = Shadow texture matrix																								; LINEINFO(ShadowModel.vsh)(8)\n";
 	 push @output, ";	 $SHADER_SPECIFIC_CONST_3	 = Tex origin																								; LINEINFO(ShadowModel.vsh)(9)\n";
 	 push @output, ";	 $SHADER_SPECIFIC_CONST_4	 = Tex Scale																								; LINEINFO(ShadowModel.vsh)(10)\n";
 	 push @output, ";	 $SHADER_SPECIFIC_CONST_5	 = [Shadow falloff offset, 1/Shadow distance, Shadow scale, 0 ]																								; LINEINFO(ShadowModel.vsh)(11)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(ShadowModel.vsh)(12)\n";
...
push @output, "; Vertex blending (whacks r1-r7, positions in r7, normals in r8)																								; LINEINFO(ShadowModel.vsh)(17)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(ShadowModel.vsh)(18)\n";
&AllocateRegister( \$worldPos, "\$worldPos" );																								
&AllocateRegister( \$worldNormal, "\$worldNormal" );																								
&SkinPositionAndNormal( $worldPos, $worldNormal );																								
push @output, "; Transform the position from world to view space																								; LINEINFO(ShadowModel.vsh)(23)\n";
&AllocateRegister( \$projPos, "\$projPos" );																								
push @output, "dp4 $projPos.x, $worldPos, $cViewProj0																								; LINEINFO(ShadowModel.vsh)(26)\n";
push @output, "dp4 $projPos.y, $worldPos, $cViewProj1																								; LINEINFO(ShadowModel.vsh)(27)\n";
push @output, "dp4 $projPos.z, $worldPos, $cViewProj2																								; LINEINFO(ShadowModel.vsh)(28)\n";
push @output, "dp4 $projPos.w, $worldPos, $cViewProj3																								; LINEINFO(ShadowModel.vsh)(29)\n";
push @output, "mov oPos, $projPos																								; LINEINFO(ShadowModel.vsh)(30)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(ShadowModel.vsh)(32)\n";
push @output, "; Fog																								; LINEINFO(ShadowModel.vsh)(33)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(ShadowModel.vsh)(34)\n";
&CalcFog( $worldPos, $projPos );																								
&FreeRegister( \$projPos, "\$projPos" );																								
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(ShadowModel.vsh)(38)\n";
push @output, "; Transform position into texture space (from 0 to 1)																								; LINEINFO(ShadowModel.vsh)(39)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(ShadowModel.vsh)(40)\n";
&AllocateRegister( \$texturePos, "\$texturePos" );																								
push @output, "dp4 $texturePos.x, $worldPos, $SHADER_SPECIFIC_CONST_0																								; LINEINFO(ShadowModel.vsh)(42)\n";
push @output, "dp4 $texturePos.y, $worldPos, $SHADER_SPECIFIC_CONST_1																								; LINEINFO(ShadowModel.vsh)(43)\n";
push @output, "dp4 $texturePos.z, $worldPos, $SHADER_SPECIFIC_CONST_2																								; LINEINFO(ShadowModel.vsh)(44)\n";
&FreeRegister( \$worldPos, "\$worldPos" );																								
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(ShadowModel.vsh)(47)\n";
push @output, "; Figure out the shadow fade amount																								; LINEINFO(ShadowModel.vsh)(48)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(ShadowModel.vsh)(49)\n";
&AllocateRegister( \$shadowFade, "\$shadowFade" );																								
push @output, "sub $shadowFade, $texturePos.z, $SHADER_SPECIFIC_CONST_5.x																								; LINEINFO(ShadowModel.vsh)(51)\n";
push @output, "mul $shadowFade, $shadowFade, $SHADER_SPECIFIC_CONST_5.y																								; LINEINFO(ShadowModel.vsh)(52)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(ShadowModel.vsh)(54)\n";
push @output, "; Offset it into the texture																								; LINEINFO(ShadowModel.vsh)(55)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(ShadowModel.vsh)(56)\n";
&AllocateRegister( \$actualTextureCoord, "\$actualTextureCoord" );																								
push @output, "mul $actualTextureCoord.xyz, $SHADER_SPECIFIC_CONST_4, $texturePos																								; LINEINFO(ShadowModel.vsh)(58)\n";
push @output, "add oT0.xyz, $actualTextureCoord, $SHADER_SPECIFIC_CONST_3																								; LINEINFO(ShadowModel.vsh)(59)\n";
push @output, ";mov oT0.xyz, $texturePos																								; LINEINFO(ShadowModel.vsh)(60)\n";
&FreeRegister( \$actualTextureCoord, "\$actualTextureCoord" );																								
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(ShadowModel.vsh)(63)\n";
push @output, "; We're doing clipping by using texkill																								; LINEINFO(ShadowModel.vsh)(64)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(ShadowModel.vsh)(65)\n";
push @output, "mov oT1.xyz, $texturePos		; also clips when shadow z < 0 !																								; LINEINFO(ShadowModel.vsh)(66)\n";
push @output, "sub oT2.xyz, $cOne, $texturePos																								; LINEINFO(ShadowModel.vsh)(67)\n";
push @output, "sub oT2.z, $cOne, $shadowFade.z	; clips when shadow z > shadow distance																									; LINEINFO(ShadowModel.vsh)(68)\n";
&FreeRegister( \$texturePos, "\$texturePos" );																								
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(ShadowModel.vsh)(71)\n";
push @output, "; We're doing backface culling by using texkill also (wow yucky)																								; LINEINFO(ShadowModel.vsh)(72)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(ShadowModel.vsh)(73)\n";
push @output, "; Transform z component of normal in texture space																								; LINEINFO(ShadowModel.vsh)(74)\n";
push @output, "; If it's negative, then don't draw the pixel																								; LINEINFO(ShadowModel.vsh)(75)\n";
push @output, "dp3 oT3, $worldNormal, -$SHADER_SPECIFIC_CONST_2																								; LINEINFO(ShadowModel.vsh)(76)\n";
&FreeRegister( \$worldNormal, "\$worldNormal" );																								
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(ShadowModel.vsh)(79)\n";
push @output, "; Shadow color, falloff																								; LINEINFO(ShadowModel.vsh)(80)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(ShadowModel.vsh)(81)\n";
push @output, "mov oD0, $cModulationColor																								; LINEINFO(ShadowModel.vsh)(82)\n";
push @output, "mul oD0.w, $shadowFade.x, $SHADER_SPECIFIC_CONST_5.z																								; LINEINFO(ShadowModel.vsh)(83)\n";
