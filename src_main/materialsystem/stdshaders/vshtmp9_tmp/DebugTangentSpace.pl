...
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(DebugTangentSpace.vsh)(8)\n";
push @output, "; Vertex blending 																								; LINEINFO(DebugTangentSpace.vsh)(9)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(DebugTangentSpace.vsh)(10)\n";
&AllocateRegister( \$worldPos, "\$worldPos" );																								
&AllocateRegister( \$worldNormal, "\$worldNormal" );																								
&SkinPositionAndNormal( $worldPos, $worldNormal );																								
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(DebugTangentSpace.vsh)(15)\n";
push @output, "; Transform the position from world to view space																								; LINEINFO(DebugTangentSpace.vsh)(16)\n";
push @output, ";------------------------------------------------------------------------------																								; LINEINFO(DebugTangentSpace.vsh)(17)\n";
&AllocateRegister( \$projPos, "\$projPos" );																								
push @output, "dp4 $projPos.x, $worldPos, $cViewProj0																								; LINEINFO(DebugTangentSpace.vsh)(21)\n";
push @output, "dp4 $projPos.y, $worldPos, $cViewProj1																								; LINEINFO(DebugTangentSpace.vsh)(22)\n";
push @output, "dp4 $projPos.z, $worldPos, $cViewProj2																								; LINEINFO(DebugTangentSpace.vsh)(23)\n";
push @output, "dp4 $projPos.w, $worldPos, $cViewProj3																								; LINEINFO(DebugTangentSpace.vsh)(24)\n";
push @output, "mov oPos, $projPos																								; LINEINFO(DebugTangentSpace.vsh)(25)\n";
&FreeRegister( \$worldPos, "\$worldPos" );																								
push @output, "; stick the normal in the color channel																								; LINEINFO(DebugTangentSpace.vsh)(29)\n";
push @output, "mov oD0.xyz, $worldNormal.xyz																								; LINEINFO(DebugTangentSpace.vsh)(30)\n";
push @output, "mov oD0.w, $cOne				; make sure all components are defined																								; LINEINFO(DebugTangentSpace.vsh)(31)\n";
&FreeRegister( \$projPos, "\$projPos" );																								
