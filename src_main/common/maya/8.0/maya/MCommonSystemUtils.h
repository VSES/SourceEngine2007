...
// *****************************************************************************
//
// CLASS DESCRIPTION (MCommonSystemUtils)
//
...
public:
	/// 
	static MStatus getEnv( MString &variable, MString &result );
	///
	static MStatus putEnv( MString &variable, MString &value );
	///
	static MStatus makeDirectory( MString &path );
