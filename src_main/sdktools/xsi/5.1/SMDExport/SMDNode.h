...
public:
	...
	*/
	void		SetHierarchicalCompensation( CSLTransform* in_mMatrix );

	/*!	Sets the Node's Second Hierarchical Compensation matrix
	\param	CSIBCMatrix4x4	HC matrix
	*/
	void		SetHierarchicalCompensation2( CSLTransform* in_mMatrix );
	

	/*!	Gets the Node's Hierarchical Compensation matrix
	\return		CSIBCMatrix4x4&
	*/
	CSLTransform*		GetHierarchicalCompensation() { return m_mHierarchyCompensation; }; 

	/*!	Gets the Node's Second Hierarchical Compensation matrix
	\return		CSIBCMatrix4x4&
	*/
	CSLTransform*		GetHierarchicalCompensation2() { return m_mHierarchyCompensation2; }; 
...
private:
	...
	CSLTransform	*m_mHierarchyCompensation;
	CSLTransform	*m_mHierarchyCompensation2;
};
...
public:
	...
	\return	nothing
	*/
	void AddNode ( char *in_szName, int in_iParentID, CSLModel * in_pModel, CSLTransform*	l_pHierarchyCompensation = NULL ,CSLTransform*	l_pHierarchyCompensation2 = NULL );
	...
	\return	nothing
	*/
	void AddNode ( char *in_szName, char *in_szParentName, CSLTransform*	l_pHierarchyCompensation = NULL, CSLTransform*	l_pHierarchyCompensation2 = NULL );
	...
	*/
	SMDNode*	GetByName ( SI_Char* in_szName );
